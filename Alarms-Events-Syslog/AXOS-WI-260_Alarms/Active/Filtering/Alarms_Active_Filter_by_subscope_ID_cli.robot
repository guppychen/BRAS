...
Alarms_Active_Filter_by_subscope_ID
    ...
    [Tags]        @tcid=AXOS_E72_PARENT-TC-2849      @functional    @priority=P2      @user_interface=CLI
    ...
    Wait Until Keyword Succeeds    30 seconds    5 seconds    Verifying Active Alarm subscope gets filtered using ID        n1        ${total_count}
