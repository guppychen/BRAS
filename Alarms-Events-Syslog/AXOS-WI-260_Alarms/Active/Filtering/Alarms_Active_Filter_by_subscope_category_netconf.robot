...
Alarms_Active_Filter_by_subscope_category
    ...
    [Tags]          @tcid=AXOS_E72_PARENT-TC-2845      @functional    @priority=P2      @user_interface=netconf
    ...
    Wait Until Keyword Succeeds    30 seconds    5 seconds    Verifying Active Alarm subscope gets filtered by category using netconf     n1_netconf        ${total_count}
