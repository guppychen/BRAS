*** Settings ***
Documentation     This test suite is going to verify whether the event definitions are shown as per count using netconf
...
Event_Definition_Count
    [Documentation]    Test case verifies event definitions are shown as per count via netconf
    ...
    [Tags]           @tcid=AXOS_E72_PARENT-TC-2870    @functional    @priority=P2     @user_interface=netconf
