...
*** Test Cases ***
tc_Multiple_Subscribers_on_Same_Port
    [Documentation]    1	2 subscribers on same port. Send V3 report no SRC IP	Verify other subscriber is not affected by this report
    [Tags]       @author=philip_chen     @TCID=AXOS_E72_PARENT-TC-2284    @GlobalID=2346551
    [Setup]      case setup
    [Teardown]   case teardown
    log    STEP:1 2 subscribers on same port. Send V3 report no SRC IP Verify other subscriber is not affected by this report
    ...
    ${save_file}    set variable    ${p_tg_store_file_path}/TC-2284.pcap
...
case setup
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-2284 setup


case teardown
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-2284 teardown
