...
IGMPV3_ASM_suite_provision
    ...
    subscriber_point_add_svc    subscriber_point2    ${p_match_vlan_ont}    ${p_data_vlan}    mcast_profile=${p_mcast_prf2}    cfg_prefix=auto2
    subscriber_point_add_svc    subscriber_point3    ${p_match_vlan_ont}    ${p_data_vlan}    mcast_profile=${p_mcast_prf2}    cfg_prefix=auto3
IGMPV3_ASM_deprovision
    ...
    subscriber_point_remove_svc    subscriber_point2    ${p_match_vlan_ont}    ${p_data_vlan}    mcast_profile=${p_mcast_prf2}    cfg_prefix=auto2
    subscriber_point_remove_svc    subscriber_point3    ${p_match_vlan_ont}    ${p_data_vlan}    mcast_profile=${p_mcast_prf2}    cfg_prefix=auto3
