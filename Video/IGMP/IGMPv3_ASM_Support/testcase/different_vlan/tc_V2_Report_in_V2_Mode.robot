...
*** Test Cases ***
tc_V2_Report_in_V2_Mode
    [Documentation]    1	sysytem in V2 mode. Host sends a V2 report (join) to E7. Show mcast.	Verify IGMP exchange through system & mrouter is V2 and show mcast lists mcast IP/VLAN with no SRC IP.
    [Tags]       @author=philip_chen     @TCID=AXOS_E72_PARENT-TC-2278    @GlobalID=2346545
    [Setup]      case setup
    [Teardown]   case teardown
    log    STEP:1 sysytem in V2 mode. Host sends a V2 report (join) to E7. Show mcast. Verify IGMP exchange through system & mrouter is V2 and show mcast lists mcast IP/VLAN with no SRC IP.
    ...
    ${save_file}    set variable    ${p_tg_store_file_path}/TC-2278.pcap
...
case setup
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-2278 setup
...
case teardown
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-2278 teardown
