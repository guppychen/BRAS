...
*** Test Cases ***
tc_V2_Report_in_V3_Mode
    [Documentation]    1	system in V3 mode. Host sends a V2 report to system. Show vlan detail.	The system(vlan) is operating in V3 mode. system responds with V2 query. E7(vlan) remains as V3
    [Tags]       @author=philip_chen     @TCID=AXOS_E72_PARENT-TC-2281    @GlobalID=2346548
    [Setup]      case setup
    [Teardown]   case teardown
    log    STEP:1 system in V3 mode. Host sends a V2 report to system. Show vlan detail. The system(vlan) is operating in V3 mode. system responds with V2 query. E7(vlan) remains as V3
    ...
    ${save_file}    set variable    ${p_tg_store_file_path}/TC-2281.pcap
...
case setup
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-2281 setup
...
case teardown
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-2281 teardown
