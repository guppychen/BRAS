*** Settings ***
Documentation     Initialization file test suites for mvr topo1
...
Force Tags        @feature=IGMP    @subfeature=MVR support    @author=CindyGao    @topo=1pon1ont
Resource          ./base.robot
...
mvr_suite_provision
    ...
    prov_vlan_egress    eutA    ${p_data_vlan}    broadcast-flooding    ENABLED    # Modified by AT-5444
    : FOR    ${video_vlan}    IN    @{p_video_vlan_list}
    \    prov_vlan    eutA    ${video_vlan}
    prov_vlan_egress    eutA    ${video_vlan}    broadcast-flooding    ENABLED    # Modified by AT-5444
    ...
    prov_igmp_profile    eutA    ${p_igmp_prf}    ${p_igmp_version}
