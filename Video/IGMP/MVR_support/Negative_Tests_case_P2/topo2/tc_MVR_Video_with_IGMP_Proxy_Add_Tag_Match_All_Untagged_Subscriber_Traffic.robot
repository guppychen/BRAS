*** Settings ***
Documentation    MVR Video with IGMP Proxy (Add Tag Match All Untagged Subscriber Traffic) 
Resource     ./base.robot
...
*** Test Cases ***
tc_MVR_Video_with_IGMP_Proxy_Add_Tag_Match_All_Untagged_Subscriber_Traffic
    [Documentation]
    ...    1	Add basic MVR video service to two ONT ports. (Add Tag Match All Untagged Subscriber Traffic)  		
    ...
    [Tags]     @tcid=AXOS_E72_PARENT-TC-1531      @subFeature=MVR support      @globalid=2321600      @priority=P2      @user_interface=CLI    @eut=NGPON2-4
    ...        @jira=PREM-24229
    [Setup]     case setup
    [Teardown]     case teardown
      
    log    STEP:1 Add basic MVR video service to two ONT ports. (Change Tag Match Single Tagged Subscriber Traffic) 
    subscriber_point_add_svc    subscriber_point1    untagged    ${p_data_vlan}    mcast_profile=auto_mcast_prf_0
...
case teardown
    ...
    subscriber_point_remove_svc    subscriber_point1    untagged    ${p_data_vlan}    mcast_profile=auto_mcast_prf_0
