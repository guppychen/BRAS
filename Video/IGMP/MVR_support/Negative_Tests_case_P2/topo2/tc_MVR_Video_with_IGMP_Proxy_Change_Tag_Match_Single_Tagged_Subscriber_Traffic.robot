*** Settings ***
Documentation    MVR Video with IGMP Proxy (Change Tag Match Single Tagged Subscriber Traffic)
Resource     ./base.robot
...
*** Test Cases ***
tc_MVR_Video_with_IGMP_Proxy_Change_Tag_Match_Single_Tagged_Subscriber_Traffic
    [Documentation]
    ...    1	Add basic MVR video service to two ONT ports. (Change Tag Match Single Tagged Subscriber Traffic)			
    ...
    [Tags]     @tcid=AXOS_E72_PARENT-TC-1536      @subFeature=MVR support      @globalid=2321605      @priority=P2      @user_interface=CLI    @eut=NGPON2-4
    ...        @jira=PREM-24229
    [Setup]     case setup
    [Teardown]     case teardown
      
    log    STEP:1 Add basic MVR video service to two ONT ports. (Change Tag Match Single Tagged Subscriber Traffic) 
    subscriber_point_add_svc    subscriber_point1    ${p_match_vlan}    ${p_data_vlan}    cevlan_action=remove-cevlan    mcast_profile=auto_mcast_prf_0
