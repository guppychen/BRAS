*** Settings ***
Documentation     Verify traffic recovers after enabling ont-ethernet
Resource          ./base.robot
...
*** Test Cases ***
tc_disable_enable_ont_ethernet
    [Documentation]    Verify traffic recovers after enabling ont-ethernet
    [Tags]       @author=AnsonZhang     @TCID=AXOS_E72_PARENT-TC-1611    @globalid=2321686    @priority=P1    @eut=NGPON2-4    @eut=GPON-8r2
    [Setup]      case setup
