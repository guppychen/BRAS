*** Settings ***
Documentation     (IGMPV3)Verify non mvr Video on the G8032 Neighbor node
Resource          ./base.robot
...
*** Test Cases ***
tc_IGMPV3_Verify_non_mvr_Video_on_the_g8032_Neighbor_node    
    ...
    [Tags]       @author=CindyGao     @TCID=AXOS_E72_PARENT-TC-1741    @globalid=2322269    @priority=P1    @user_interface=CLI    @eut=NGPON2-4    @eut=GPON-8r2
