*** Settings ***
Documentation     (IGMPV3)Switch G8032 none mode and check non-mvr video
Resource          ./base.robot
...
*** Test Cases ***
tc_IGMPV3_Switch_G8032_none_node_and_check_non_mvr_video    
    ...
    [Tags]       @author=CindyGao     @TCID=AXOS_E72_PARENT-TC-1748    @globalid=2322276    @priority=P1    @user_interface=CLI    @eut=NGPON2-4    @eut=GPON-8r2
