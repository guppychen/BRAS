*** Settings ***
Documentation     (IGMPV2)Switch G8032 master mode and check non-mvr video
Resource          ./base.robot
...
*** Test Cases ***
tc_IGMPV2_Switch_G8032_master_node_and_check_non_mvr_video    
    [Documentation]    Configure G8032 ring and IGMPv2 non-mvr on Topo1
    ...    1    Switch G8032 master mode and check non-mvr video	IPTV works fine
    [Tags]       @author=CindyGao     @TCID=AXOS_E72_PARENT-TC-1728    @globalid=2322256    @priority=P2    @user_interface=CLI    @eut=NGPON2-4     @eut=GPON-8r2
