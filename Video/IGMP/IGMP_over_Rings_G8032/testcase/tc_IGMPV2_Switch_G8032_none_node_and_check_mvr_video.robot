*** Settings ***
Documentation     (IGMPV2)Switch G8032 none mode and check mvr video
Resource          ./base.robot
...
*** Test Cases ***
tc_IGMPV2_Switch_G8032_none_node_and_check_mvr_video    
    [Documentation]    Configure G8032 ring and IGMPv2 mvr on Topo1
    ...    1    Switch G8032 none mode and check mvr video	IPTV works fine
    [Tags]       @author=CindyGao     @TCID=AXOS_E72_PARENT-TC-1735    @globalid=2322263    @priority=P1    @user_interface=CLI    @eut=NGPON2-4    @eut=GPON-8r2
