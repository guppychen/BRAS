*** Settings ***
Documentation     (IGMPV3)Switch G8032 neighbor mode and check mvr video
Resource          ./base.robot
...
*** Test Cases ***
tc_IGMPV3_Switch_G8032_neighbor_node_and_check_mvr_video    
    ...
    [Tags]       @author=CindyGao     @TCID=AXOS_E72_PARENT-TC-1743    @globalid=2322271    @priority=P1    @user_interface=CLI    @eut=NGPON2-4    @eut=GPON-8r2
