*** Settings ***
Documentation     (IGMPV3)Verify mvr Video on the G8032 none node
Resource          ./base.robot
...
*** Test Cases ***
tc_IGMPV3_Verify_mvr_Video_on_the_g8032_none_node    
    [Documentation]    Configure G8032 ring and IGMPv3 mvr on Topo1
    ...    1    Verify mvr Video on the G8032 none node	IPTV works fine
    [Tags]       @author=CindyGao     @TCID=AXOS_E72_PARENT-TC-1746    @globalid=2322274    @priority=P1    @user_interface=CLI    @eut=NGPON2-4    @eut=GPON-8r2
