*** Settings ***
Documentation     (IGMPV2)Verify non mvr Video on the ERPS master node
Resource          ./base.robot
...
*** Test Cases ***
tc_IGMPV2_Verify_non_mvr_Video_on_the_ERPS_master_node    
    ...
    [Tags]       @author=CindyGao     @TCID=AXOS_E72_PARENT-TC-1827    @globalid=2324419    @priority=P1    @user_interface=CLI    @eut=NGPON2-4    @eut=GPON-8r2
