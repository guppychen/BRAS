...
Suite Setup       igmp_over_erps_suite_provision
Suite Teardown    igmp_over_erps_suite_deprovision
Force Tags        @feature=IGMP    @subfeature=IGMP over Rings (ERPS)    @author=CindyGao
Resource          ./base.robot
...
*** Keywords ***
igmp_over_erps_suite_provision
    [Documentation]    suite provision for IGMP over Rings (ERPS)
...
igmp_over_erps_suite_deprovision
    [Documentation]    suite deprovision for IGMP over Rings (ERPS)
    [Tags]       @author=CindyGao
