...
*** Test Cases ***
tc_start_vca_join_ip_with_not_flow_ip
    [Documentation]    check it can works fine    
    [Tags]     @author=YUE SUN    @tcid=AXOS_E72_PARENT-TC-4566      @globalid=2533290      @priority=P2      @eut=NGPON2-4    @eut=GPON-8r2    @eut=10GE-12    @eut=GE-24r2          @user_interface=CLI    
    [Setup]     case_setup
