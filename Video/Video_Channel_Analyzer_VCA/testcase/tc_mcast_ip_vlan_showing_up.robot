...
*** Test Cases ***
tc_mcast_ip_vlan_showing_up
    [Documentation]    check it can works fine
    [Tags]     @author=YUE SUN    @tcid=AXOS_E72_PARENT-TC-4581      @globalid=2533305      @priority=P2      @eut=NGPON2-4    @eut=GPON-8r2    @eut=10GE-12    @eut=GE-24r2          @user_interface=CLI    
    [Setup]     case_setup
    ...
    log    STEP 1: show vca, multicast ip, van can showing up properly 
