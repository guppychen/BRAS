...
tc_disable_ETH_port
    ...
    [Tags]     @author=YUE SUN    @tcid=AXOS_E72_PARENT-TC-4592      @globalid=2533316      @priority=P2      @eut=NGPON2-4    @eut=GPON-8r2    @eut=10GE-12    @eut=GE-24r2          @user_interface=CLI    
    [Setup]     case_setup
    [Teardown]     case_teardown
      
    log    STEP 1: Enabled ETH port, check vca can works fine
    ...
    log    STEP 2: Disabled ETH port, check vca can works fine
