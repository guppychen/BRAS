...
*** Test Cases ***
tc_flow_coming_from_active_card
    [Documentation]    check it can works fine
    [Tags]     @author=YUE SUN    @tcid=AXOS_E72_PARENT-TC-4597      @globalid=2533321      @priority=P2      @eut=NGPON2-4    @eut=GPON-8r2    @eut=10GE-12    @eut=GE-24r2          @user_interface=CLI    
    [Setup]     case_setup
    ...
    log    STEP 1: show vca, vca can showing up properly 
