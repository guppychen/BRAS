*** Settings ***
Documentation     The purpose of this test is to Checking G8032 with CFM for different ccm meg mode.
...               1.Check g8032 ring with ccm meg mode Y1731
...               2.change ccm meg mode 8021ag and check g8032 status
...
...
*** Test Cases ***
tc_G8032_Convergence_Phase2_Topology_CFM_Meg_mode_8021ag.robot
    [Tags]       @tcid=AXOS_E72_PARENT-TC-2033     @globalid=2329425    @eut=NGPON2-4    @feature=G8032    @subfeature=G8032    @author=pzhang
    [Documentation]     The purpose of this test is to Checking G8032 with CFM for different ccm meg mode.
    ...               1.Check g8032 ring with ccm meg mode Y1731
    ...               2.change ccm meg mode 8021ag and check g8032 status
    [Setup]      setup
