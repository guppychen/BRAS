*** Settings ***
Documentation     The purpose of this test case is to verify CCM is no longer sent when the CFM G8032 is manually configured and then removed.
...
*** Test Cases ***
tc_G8032_Convergence_Topology_CFM_Config_Removed_when_Manuallly_Configured.robot
    [Tags]       @tcid=AXOS_E72_PARENT-TC-2005     @globalid=2329394    @eut=NGPON2-4    @feature=G8032    @subfeature=G8032    @author=pzhang
    [Documentation]    The purpose of this test case is to verify CCM is no longer sent when the CFM G8032 is manually configured and then removed.
    ...               1.Check g8032 ring with ccm manual
    [Setup]      setup
