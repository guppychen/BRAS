...
*** Test Cases ***
tc_G8032_Convergence_Phase2_Topology_Y1731_CCM.robot
    [Tags]       @tcid=AXOS_E72_PARENT-TC-2050     @globalid=2329442    @eut=NGPON2-4    @feature=G8032  @jira=EXA-21454   @subfeature=G8032    @author=pzhang
    [Documentation]     The purpose of this test is to Checking G8032 with CFM for different ccm meg mode.
    ...               1.Check g8032 ring with ccm meg mode Y1731
    [Setup]      setup
    log     setup megs and chenge ccm interval level 10ms

    prov_meg           eutA    ${meg1}    ccm-interval=10ms
    prov_meg           eutA    ${meg2}    ccm-interval=10ms
    prov_meg           eutB    ${meg3}    ccm-interval=10ms
    prov_meg           eutB    ${meg4}    ccm-interval=10ms
