*** Settings ***
Documentation     The purpose of this test is to Checking G8032 with CFM for different ccm intervalof meg.
...               1.Check g8032 ring with ccm interval
...
*** Test Cases ***
tc_G8032_Convergence_Phase2_Topology_ccm_interval.robot
    [Tags]       @tcid=AXOS_E72_PARENT-TC-2048     @globalid=2329440    @eut=NGPON2-4    @feature=G8032    @subfeature=G8032    @author=pzhang
    [Documentation]     The purpose of this test is to Checking G8032 with CFM for different ccm intervalof meg.
    ...               1.Check g8032 ring with ccm interval
    ...               2.change ccm interval and check g8032 status
    [Setup]      setup
    ...
    log     setup megs and chenge ccm interval level 100ms

    prov_meg           eutA    ${meg1}    ccm-interval=100ms
    prov_meg           eutA    ${meg2}    ccm-interval=100ms
    prov_meg           eutB    ${meg3}    ccm-interval=100ms
    prov_meg           eutB    ${meg4}    ccm-interval=100ms
