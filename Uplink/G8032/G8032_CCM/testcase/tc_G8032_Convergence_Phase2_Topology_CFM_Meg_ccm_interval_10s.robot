*** Settings ***
Documentation     The purpose of this test is to Checking G8032 with CFM for different ccm interval(10s) of meg.
...               1.Check g8032 ring with ccm interval(10s)
...
*** Test Cases ***
tc_G8032_Convergence_Phase2_Topology_CFM_Meg_ccm_interval_10s.robot
    [Tags]       @tcid=AXOS_E72_PARENT-TC-2031     @globalid=2329423    @eut=NGPON2-4    @feature=G8032    @subfeature=G8032    @author=pzhang
    [Documentation]    The purpose of this test is to Checking G8032 with CFM for different ccm interval(10s) of meg.
    ...               1.Check g8032 ring with ccm interval(10s)
    ...               2.change ccm interval and check g8032 status
    [Setup]      setup
