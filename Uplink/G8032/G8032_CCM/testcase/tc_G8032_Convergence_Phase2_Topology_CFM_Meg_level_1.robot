*** Settings ***
Documentation     The purpose of this test is to Checking G8032 with CFM for different levels(1) of meg.
...
*** Test Cases ***
tc_G8032_Convergence_Phase2_Topology_CFM_Meg_level_1.robot
    [Tags]       @tcid=AXOS_E72_PARENT-TC-2040     @globalid=2329432    @eut=NGPON2-4    @feature=G8032    @subfeature=G8032    @author=pzhang
    [Documentation]     The purpose of this test is to Checking G8032 with CFM for different levels(1) of meg.
    ...               1.Check g8032 ring with ccm manual
    ...               2.change mep level and check g8032 status
    [Setup]      setup
