...
*** Test Cases ***
tc_Topo2_shutdown_and_no_shutdown_erps_port_check_topology
    ...
    [Tags]        @tcid=AXOS_E72_PARENT-TC-2737    @globalid=2373829    @subfeature=ERPS    @priority=P1    @eut=NGPON2-4    @eut=GPON8-R2
    [Setup]       setup
    [Teardown]    teardown
    ...
    ${hostname}    get_hostname    ${service_model.service_point2.device}
    should be equal    ${neiname_1}    ${hostname}
    should be equal    ${neiport_1}    ${service_model.service_point2.member.interface1}
