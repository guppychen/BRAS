...
*** Test Cases ***
tc_Topo1_run_DHCPv4_traffic_do_erps_switch_measure_switch_time_and_service_recover
    ...
    ...    3	reboot forwarding card, wait until erps back to complete	check packet loss     
    [Tags]       @tcid=AXOS_E72_PARENT-TC-1264    @globalid=2319014    @subfeature=ERPS    @priority=P1    @eut=NGPON2-4    @eut=GPON8-R2
    [Setup]      setup
    [Teardown]   teardown
    ...
    Tg Save Config Into File    tg1    /tmp/erps_dhcp.xml
