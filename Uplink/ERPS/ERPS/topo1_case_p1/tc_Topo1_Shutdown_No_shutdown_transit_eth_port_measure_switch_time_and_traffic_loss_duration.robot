...
*** Variables ***
*** Test Cases ***
tc_Topo1_Shutdown_No_shutdown_transit_eth_port_measure_switch_time_and_traffic_loss_duration
    ...
    [Tags]       @tcid=AXOS_E72_PARENT-TC-1292    @globalid=2319042    @subfeature=ERPS    @priority=P1    @eut=NGPON2-4    @eut=GPON8-R2
    [Setup]       setup
    [Teardown]    teardown
...
setup
    ...
    ${transport_prf}    service_point_add_vlan    service_point_list2    ${service_vlan}
