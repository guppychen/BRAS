...
*** Variables ***
*** Test Cases ***
tc_Topo2_Shutdown_No_shutdown_master_eth_port_measure_switch_time_and_traffic_loss_duration
    ...
    [Tags]       @tcid=AXOS_E72_PARENT-TC-1293    @globalid=2319043    @subfeature=ERPS    @priority=P2    @eut=NGPON2-4    @eut=GPON8-R2
    [Setup]       setup
    [Teardown]    teardown
