...
*** Variables ***
*** Test Cases ***
tc_mixture_erps_and_LAG_run_unicast_traffic_switch_measure_service_recover
    ...
    [Tags]       @tcid=AXOS_E72_PARENT-TC-2931    @globalid=2391501    @subfeature=ERPS    @priority=P2    @eut=NGPON2-4     @eut=GPON8-R2
    [Setup]      case setup
    ...
    log    STEP:2 switch lag and check port status
