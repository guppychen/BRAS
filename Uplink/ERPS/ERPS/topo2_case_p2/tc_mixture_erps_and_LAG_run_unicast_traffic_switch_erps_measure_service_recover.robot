...
*** Test Cases ***
tc_mixture_erps_and_LAG_run_unicast_traffic_switch_erps_measure_service_recover
    ...
    [Tags]       @tcid=AXOS_E72_PARENT-TC-1312    @globalid=2319062    @subfeature=ERPS    @priority=P2    @eut=NGPON2-4    @eut=GPON8-R2
    [Setup]      case setup
    ...
    log    STEP:2 switch erps doesn't affect lag and services recover
    Tg Start All Traffic    tg1
...
case setup
    ...
    :FOR    ${erps_node}    IN    @{service_model.service_point_list4}
    \    log    create dhcp-profile
    \    prov_dhcp_profile    ${service_model.${erps_node}.device}    ${dhcp_profile_name}
    \    log    create service vlan
    \    prov_vlan    ${service_model.${erps_node}.device}    ${service_vlan}    ${dhcp_profile_name}
    ...
    log     ${service_model.service_point6.type}    
