...
*** Variables ***
*** Test Cases ***
tc_Topo2_reboot_forwarding_card_measure_switch_time_and_service_recover
    ...
    [Tags]        @tcid=AXOS_E72_PARENT-TC-2819    @globalid=2375981    @subfeature=ERPS    @priority=P2    @eut=NGPON2-4    @eut=GPON8-R2
    [Setup]       setup
    [Teardown]    teardown
