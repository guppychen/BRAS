...
*** Test Cases ***
tc_reboot_master_node_measure_service_recover
    [Documentation]    1	reboot master node	when card is up, service recover with reansonable traffic loss
    [Tags]       @tcid=AXOS_E72_PARENT-TC-1298    @globalid=2319048    @subfeature=ERPS    @priority=P2    @eut=NGPON2-4    @eut=GPON8-R2
    [Setup]      case setup
    [Teardown]   case teardown
    log    STEP:1 reboot master node when card is up, service recover with reansonable traffic loss
