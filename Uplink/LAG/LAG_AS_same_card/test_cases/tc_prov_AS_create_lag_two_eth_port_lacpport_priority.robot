...
*** Test Cases ***
tc_prov_AS_lag_two_eth_port_lacpport_priority
    [Documentation]    prov as lag two eth_port_lacpport_priority
    [Tags]    @globalid=2439410    @tcid=AXOS_E72_PARENT-TC-3992   @subfeature=LAG_Active_Standby_Same_Card    @priority=P1    @eut=NGPON2-4
    [Setup]    case setup
    ...
    inter_parameter_modify    eutA    ${service_model.service_point3.member.interface1}    lacp-port-priority 0
    lag_mem_status    eutA    ${la2}    ${service_model.service_point3.member.interface1}    ${eth_port_status}
    
    inter_parameter_modify    eutA    ${service_model.service_point3.member.interface1}    lacp-port-priority 65535
    lag_mem_status    eutA    ${la2}    ${service_model.service_point3.member.interface1}    ${eth_port_status}
    
    inter_parameter_modify    eutA    ${service_model.service_point3.member.interface1}    lacp-port-priority 32768
    lag_mem_status    eutA    ${la2}    ${service_model.service_point3.member.interface1}    ${eth_port_status}
