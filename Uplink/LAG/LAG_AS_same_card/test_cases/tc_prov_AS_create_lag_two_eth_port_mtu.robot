...
*** Test Cases ***
tc_prov_AS_lag_two_eth_port_mtu
    [Documentation]    prov as lag two eth port mtu
    [Tags]    @globalid=2439413    @tcid=AXOS_E72_PARENT-TC-2995   @subfeature=LAG_Active_Standby_Same_Card    @priority=P1    @eut=NGPON2-4
    [Setup]    case setup
    ...
    inter_parameter_modify    eutA    ${service_model.service_point3.member.interface1}    mtu 1500
    lag_mem_status    eutA    ${la2}    ${service_model.service_point3.member.interface1}    ${eth_port_status}
    
    inter_parameter_modify    eutA    ${service_model.service_point3.member.interface1}    mtu 9600
    lag_mem_status    eutA    ${la2}    ${service_model.service_point3.member.interface1}    ${eth_port_status}
    
    inter_parameter_modify    eutA    ${service_model.service_point3.member.interface1}    mtu 2000
