...
*** Test Cases ***
tc_prov_AS_lag_two_cards_remove_active
    [Documentation]    prov as lag two cards remove active
    [Tags]    @globalid=2353719    @tcid=AXOS_E72_PARENT-TC-2343   @subfeature=LAG_Active_Standby_Same_Card   @priority=P1    @eut=NGPON2-4
    [Setup]    case setup
    ...
    lag_inter_deprov    eutA    ${service_model.service_point1.member.interface1}    ${la1}
    lag_inter_prov    eutA    ${service_model.service_point1.member.interface1}    ${la1}
