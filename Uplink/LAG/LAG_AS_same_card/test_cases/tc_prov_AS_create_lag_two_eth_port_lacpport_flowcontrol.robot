...
*** Test Cases ***
tc_prov_AS_lag_two_eth_port_lacpport_flowcontrol
    [Documentation]    prov as lag two eth_port_lacpport_flowcontrol
    [Tags]    @globalid=2439409    @tcid=AXOS_E72_PARENT-TC-2991   @subfeature=LAG_Active_Standby_Same_Card    @priority=P1    @eut=NGPON2-4
    [Setup]    case setup
    ...
    inter_parameter_modify    eutA    ${service_model.service_point3.member.interface1}    flow-control auto
    lag_mem_status    eutA    ${la2}    ${service_model.service_point3.member.interface1}    ${eth_port_status}
    
    inter_parameter_modify    eutA    ${service_model.service_point3.member.interface1}    flow-control none
    lag_mem_status    eutA    ${la2}    ${service_model.service_point3.member.interface1}    ${eth_port_status}
