...
Suite Setup       Basic_Test_Setup        n1     n2   ${lag_group}    ${lacp_mode1}
...
Verify LAG in Active mode and Traffic
    ...
    ...     20. Stop traffic
    ...     21. Shutdown the interface on one port
    ...
    ...     26. Remove transport service profile from interface
    ...     27. Remove transport service profile from lag
    ...     28. Remove interface from lag
    ...     29. Remove transport service profile

    [Tags]         @tcid=AXOS_E72_PARENT-TC-1082    @globalid=2316581    @functional    @priority=P1
...
#   Log **** Shutdown the interface on one port ****
    ...
    Wait Until Keyword Succeeds    60 Seconds    5 Seconds    Interface_shut_calix        n1    ${DEVICES.n1.ports.p2.port}    ${slot}
    Wait Until Keyword Succeeds    60 Seconds    5 Seconds    Interface_shut_calix        n2    ${DEVICES.n2.ports.p2.port}    ${slot}


#   Log ***** Check Group Member Status ****

    Wait Until Keyword Succeeds    60 Seconds    5 Seconds    Check LAG Group Member Status      n1     ${lag_group}     ${DEVICES.n1.ports.p1.port}        ${oper_state1}      active
    Wait Until Keyword Succeeds    60 Seconds    5 Seconds    Check LAG Group Member Status      n1     ${lag_group}     ${DEVICES.n1.ports.p2.port}        ${oper_state2}      down

    Wait Until Keyword Succeeds    60 Seconds    5 Seconds    Check LAG Group Member Status      n2     ${lag_group}     ${DEVICES.n2.ports.p1.port}        ${oper_state1}      active
    Wait Until Keyword Succeeds    60 Seconds    5 Seconds    Check LAG Group Member Status      n2     ${lag_group}     ${DEVICES.n2.ports.p2.port}        ${oper_state2}      down


#   Log **** Check Traffic utilization ****

    Wait Until Keyword Succeeds    60 Seconds    5 Seconds    Check Lag Interface Traffic Utilization Without Traffic Active      n1     ${lag_group}     ${DEVICES.n1.ports.p1.port}
    Wait Until Keyword Succeeds    60 Seconds    5 Seconds    Check Lag Interface Traffic Utilization With And Without Traffic Down      n1     ${lag_group}     ${DEVICES.n1.ports.p2.port}

    Wait Until Keyword Succeeds    60 Seconds    5 Seconds    Check Lag Interface Traffic Utilization Without Traffic Active      n2     ${lag_group}     ${DEVICES.n2.ports.p1.port}
    Wait Until Keyword Succeeds    60 Seconds    5 Seconds    Check Lag Interface Traffic Utilization With And Without Traffic Down      n2     ${lag_group}     ${DEVICES.n2.ports.p2.port}
...
Basic_Test_Setup
    ...
    [Arguments]     ${device1}     ${device2}     ${lag_group}     ${lacp_mode1}
