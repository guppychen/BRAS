...
Verify Link Protection/LAG/Configuration/LACP/ LACP active and passive mode - negative
    ...
    ...      7. Configure LAG Group on both the devices as passive
    ...
    [Tags]         @tcid=AXOS_E72_PARENT-TC-1027    @globalid=2316511    @functional    @priority=P1
...
#    Log   *** Verify the inventory status in E5 and E3 devices ***
    ...
    :For     ${num}     IN RANGE       1       3
         \    Wait Until Keyword Succeeds    60 Seconds    5 Seconds    Check LAG Group Status Lacp Mode         n${num}     ${lag_group}    ${lacp_mode2}

#    Log   *** Verify the LAG member status static on E3 and E5 devices ***

   :For     ${num}     IN RANGE       1       3
         \    Wait Until Keyword Succeeds    60 Seconds    5 Seconds    Check LAG Group Member Status      n1     ${lag_group}     ${DEVICES.n1.ports.p${num}.port}        ${oper_state1}      fault

    :For     ${num}     IN RANGE       1       3
         \   Wait Until Keyword Succeeds    60 Seconds    5 Seconds    Check LAG Group Member Status      n2     ${lag_group}     ${DEVICES.n2.ports.p${num}.port}        ${oper_state1}      fault

#    Log   *** Configure LAG Group on one of the devices as active ***
...
#    Log   *** Verify the inventory status in E5 and E3 devices as active ***
    ...
    :For     ${num}     IN RANGE       1       3
         \    Wait Until Keyword Succeeds    60 Seconds    5 Seconds    Check LAG Group Status Lacp Mode         n${num}     ${lag_group}    ${lacp_mode${num}}
...
Basic_Test_Setup
    ...
    :For     ${num}     IN RANGE       1       3
         \    Create LAG Group      n${num}     ${lag_group}     ${lacp_mode2}
