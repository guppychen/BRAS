...
Verify Link Protection/Configuration/Enable LACP mode/Passive
    ...
    [Tags]         @tcid=AXOS_E72_PARENT-TC-1040    @globalid=2316526    @functional    @priority=P1
...
#    Log   *** Configure LAG Group on both the devices as passive and active ***

    Create LAG Group      n1     ${lag_group}     ${lacp_mode2}
    Create LAG Group      n2     ${lag_group}     ${lacp_mode1}

#    Log   *** Verify the inventory status in E5 and E3 devices as active ***

     Wait Until Keyword Succeeds    60 Seconds    5 Seconds    Check LAG Group Status Lacp Mode         n1     ${lag_group}    ${lacp_mode2}
