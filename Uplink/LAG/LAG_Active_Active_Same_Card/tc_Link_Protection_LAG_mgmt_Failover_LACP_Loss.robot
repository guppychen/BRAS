...
Verify Link Protection/LAG/Performance/Failover on LACP loss
    ...
    [Tags]         @tcid=AXOS_E72_PARENT-TC-1098    @globalid=2316600    @functional    @priority=P2
   ...
   :For     ${num}     IN RANGE       1       3
    ...
    #Log ****keep short timeout for 1 LAG link and remove that device******
    :For     ${num}     IN RANGE       1       3
         \    Add Device Interface To LAG With Timeout    n${num}     ${DEVICES.n${num}.ports.p1.port}      ${lag_group}    ${lacp_timeout1}

    :For     ${num}     IN RANGE       1       3
         \    Wait Until Keyword Succeeds    60 Seconds    5 Seconds    Check LAG Group Ethernet Status     n${num}     ${DEVICES.n${num}.ports.p1.port}        lacp-port-timeout    ${lacp_timeout1}

    :For     ${num}     IN RANGE       1       3
         \    Unconfigure LAG Group From Device Interface   n${num}     ${DEVICES.n${num}.ports.p1.port}      ${lag_group} 
    ...
    sleep   3
     ...
     Wait Until Keyword Succeeds    60 Seconds    5 Seconds    Run Keyword And Continue On Failure    Verify Lag Interface Traffic TX RX Utilization Status    n1    n2     ${lag_group}     ${DEVICES.n1.ports.p2.port}      ${DEVICES.n2.ports.p2.port}   ${lacp_stat1}      ${value1}
    ...
    #Log ****keep long timeout for 1 LAG link and remove that device******
    :For     ${num}     IN RANGE       1       3
         \    Add Device Interface To LAG With Timeout    n${num}     ${DEVICES.n${num}.ports.p1.port}      ${lag_group}    ${lacp_timeout2}

    :For     ${num}     IN RANGE       1       3
         \    Wait Until Keyword Succeeds    60 Seconds    5 Seconds    Check LAG Group Ethernet Status     n${num}     ${DEVICES.n${num}.ports.p1.port}        lacp-port-timeout    ${lacp_timeout2}
...
Basic_Test_Setup
    ...
    :For     ${num}     IN RANGE       1       3
     ...
     :For     ${num}     IN RANGE       1       3
         \    Configure LAG Group Min Port     n${num}     ${lag_group}      ${min_port_id}

     :For     ${num}     IN RANGE       1       3
         \    Check LAG Group Min Port      n${num}     ${lag_group}      ${min_port_id}
