...
Verify LAG Static mode configuration
    ...
    ...      6. Verify the LAG status of Lacp Mode on E3 and E5 devices
    ...      7. Verify the LAG member status on E3 and E5 devices
    ...      8. Remove the LAG information from E3 and E5 devices

    [Tags]         @tcid=AXOS_E72_PARENT-TC-1037    @globalid=2316523    @functional    @priority=P1
    ...
    Log   *** Verify the LAG status of Lacp Mode on E3 and E5 devices ***
