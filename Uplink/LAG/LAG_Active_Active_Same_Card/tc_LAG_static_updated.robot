...
###-------------------------------------------------------------------
### TC_DESCRIPTION : Verify LAG Static mode settings                  
### PLATFORM	   : E5 / ROLT
### MODEL	   : All
### RUN_TYPE	   : FULL
...
# ------------------------------------------------------------------------------
# Function   : TC1
# Synopsis   : Link Protection/LAG/10Gig/Static Lag
# Return     : Pass/Fail
# ------------------------------------------------------------------------------

Verify LAG Static mode configuration get reflected in the settings

    [Documentation]        #    Action    Expected Result    Notes
    ...    1 Configure Static  LAG Interface
    ...
    ...    7 Verify Static LAG got reflected in settings

    [Tags]       @tcid=AXOS_E72_PARENT-TC-1079    @globalid=2316576    @smoke   @priority=P1
...
#***** 7. Verify LACP  Mode *****
    Wait Until Keyword Succeeds    60 Seconds    5 Seconds    Check LACP Mode      n1     ${lag_group}      ${lacp_mode}
    Wait Until Keyword Succeeds    60 Seconds    5 Seconds    Check LACP Mode      n2     ${lag_group}      ${lacp_mode}
