...
*** Test Cases ***
Verify LAG Static mode configuration
    ...
    ...     17. Stop traffic
    ...     18. Verify LAG Hash method as SRC_MAC using traffic
    ...     19. Starting traffic
    ...     20. Check Traffic utilization
    ...     21. Stop traffic
    ...     22. Remove transport service profile from interface
    ...     23. Remove transport service profile from lag
    ...     24. Remove interface from lag
    ...     25. Remove transport service profile 

    [Tags]         @tcid=AXOS_E72_PARENT-TC-1103    @globalid=2316609    @functional    @priority=P1
