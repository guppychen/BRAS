...
###-------------------------------------------------------------------
### TC_DESCRIPTION : Verify LAG Active link Traffic For Unicast Multicast & Broadcast
### PLATFORM       : E3
### MODEL          : All
### RUN_TYPE       : FULL
...
*** Settings ***
Documentation     Verify LAG Active Link Traffic For Unicast, Multicast, Broadcast
Resource          base.robot
...
Verify E5 device running configuration data *****
   ...
   log    * 4 Transport Service Profile Created *****
   ...
   log    * 5. Add ethernet interface of E3 device to the LAG group *****
   ...
   log    * 6. Verify ethernet interface of E3 device added to the LAG group *****
   ...
   log    * 7. Add ethernet interface of E5 device to the LAG group *****
   ...
   log    * 8. Verify ethernet interface of E5 device added to the LAG group *****
   ...
   log    * 9. Add Transport Service Profile To The Lag Group ****
   ...
   log    * 10 Transport Service Profile Added To The Lag Group ****
   ...
   log    * 11 Add Transport Service Profile To Ethernet Interface ****
   ...
   log    * 12 Transport Service Profile Added To Ethernet Interface ****
   ...
   log    * 13. Configure LAG group Max-port to 1 *****
   ...
   log    * 14. Verify LAG group Max-port *****
   ...
   log    * 15 Check Group Member Status ****
   ...
   log    * 16 Clear Lag interface Counters ****
   ...
   log    * 17 Check Lag Interface Tx and Rx Counters Without Traffic ****
   ...
   log     18 Check Traffic utilization
   ...
   log    * 19. Verify LAG using traffic unicast *****
   ...
   log     20 Starting traffic ****
    Tg Start All Traffic    tg1

   log     21 Check Traffic utilization
...
#Compare Counters
   ...
   log    * 22 Clear Lag interface Counters ****
    Wait Until Keyword Succeeds    60 Seconds    5 Seconds    Clear Lag Interface Counters      n1     ${lag_group}
    Wait Until Keyword Succeeds    60 Seconds    5 Seconds    Clear Lag Interface Counters      n2     ${lag_group}

   log    * 23 Check Lag Interface Tx and Rx Counters Without Traffic ****
    Wait Until Keyword Succeeds    60 Seconds    5 Seconds    Check Lag Interface Tx Counters Without Traffic      n1     ${lag_group}
    Wait Until Keyword Succeeds    60 Seconds    5 Seconds    Check Lag Interface Rx Counters Without Traffic      n2     ${lag_group}

   log    * 24. Verify LAG using traffic multicast *****
    Tg Create Single Tagged Stream On Port          tg1     up_2        p2          p1        vlan_id=500     vlan_user_priority=7            mac_src=00:00:01:00:00:01       mac_dst=00:00:5E:00:00:02            l3_protocol=ipv4       ip_src_addr=192.168.1.1          ip_dst_addr=224.0.0.1       rate_percent=100.00     frame_size=1024         length_mode=fixed

   log     25 Starting traffic ****
    Tg Start All Traffic    tg1

   log     26 Check Traffic utilization
##Traffic Will Flow from 1 interface only From Active link No Traffic From Standby
    Wait Until Keyword Succeeds    60 Seconds    5 Seconds    Check Lag Interface Traffic Utilization With Traffic Active      n1     ${lag_group}     ${DEVICES.n1.ports.p1.port}
    ...
    Wait Until Keyword Succeeds    60 Seconds    5 Seconds    Check Lag Interface Counters With Traffic Tx     n1     ${lag_group}     ${packet_type2}
    Wait Until Keyword Succeeds    60 Seconds    5 Seconds    Check Lag Interface Counters With Traffic Rx     n2     ${lag_group}     ${packet_type2}
    Tg Stop All Traffic    tg1

#Compare Counters
#    Wait Until Keyword Succeeds    60 Seconds    5 Seconds    Check Lag Counters For Tx And Rx     n1     n2     ${lag_group}     ${packet_type2}

    Wait Until Keyword Succeeds    60 Seconds    5 Seconds    tg delete traffic stream    tg1    up_2

   log    * 27 Clear Lag interface Counters ****

    Wait Until Keyword Succeeds    60 Seconds    5 Seconds    Clear Lag Interface Counters      n1     ${lag_group}
    Wait Until Keyword Succeeds    60 Seconds    5 Seconds    Clear Lag Interface Counters      n2     ${lag_group}

   log    * 28 Check Lag Interface Tx and Rx Counters Without Traffic ****

    Wait Until Keyword Succeeds    60 Seconds    5 Seconds    Check Lag Interface Counters Without Traffic Tx     n1     ${lag_group}     ${packet_type2}
    Wait Until Keyword Succeeds    60 Seconds    5 Seconds    Check Lag Interface Counters Without Traffic Rx     n2     ${lag_group}     ${packet_type2}

   log    * 29. Verify LAG using traffic broadcast *****

    Tg Create Single Tagged Stream On Port          tg1     up_3        p2          p1        vlan_id=500     vlan_user_priority=7            mac_src=00:00:01:00:00:01       mac_dst=FF:FF:FF:FF:FF:FF            l3_protocol=ipv4       ip_src_addr=192.168.1.1          ip_dst_addr=192.168.1.155       rate_percent=100.00     frame_size=1024         length_mode=fixed

   log     30 Starting traffic ****

    Tg Start All Traffic    tg1

   log     31 Check Traffic utilization
...
#Traffic Will Flow from 1 interface only From Active link No Traffic From Standby
    ...
    Wait Until Keyword Succeeds    60 Seconds    5 Seconds    Check Lag Interface Counters With Traffic Tx     n1     ${lag_group}     ${packet_type3}
    Wait Until Keyword Succeeds    60 Seconds    5 Seconds    Check Lag Interface Counters With Traffic Rx     n2     ${lag_group}     ${packet_type3}
    Tg Stop All Traffic    tg1

#Compare Counters

    Wait Until Keyword Succeeds    60 Seconds    5 Seconds    Check Lag Counters For Tx And Rx     n1     n2     ${lag_group}     ${packet_type3}
    Wait Until Keyword Succeeds    60 Seconds    5 Seconds    tg delete traffic stream    tg1    up_3

   log    * 32 Clear Lag interface Counters ****

    Wait Until Keyword Succeeds    60 Seconds    5 Seconds    Clear Lag Interface Counters      n1     ${lag_group}
    Wait Until Keyword Succeeds    60 Seconds    5 Seconds    Clear Lag Interface Counters      n2     ${lag_group}

   log    * 33 Check Lag Interface Tx and Rx Counters Without Traffic ****

    Wait Until Keyword Succeeds    60 Seconds    5 Seconds    Check Lag Interface Counters Without Traffic Tx     n1     ${lag_group}     ${packet_type3}
    Wait Until Keyword Succeeds    60 Seconds    5 Seconds    Check Lag Interface Counters Without Traffic Rx     n2     ${lag_group}     ${packet_type3}
...
Basic_Test_Teardown
    ...
    [Arguments]      ${device1}     ${device2}      ${lag_group}
   log     34 Remove transport service profile from interface
   ...
   log     36 Remove interface from lag
    ...
    log     37 Remove transport service profile
