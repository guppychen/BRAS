...
Veopy E5 device running configuration data *****
    ...
    ...    13 Configure LAG Hash method as SRC_MAC for the LAG group.
    ...    14 Verify LAG Hash method as SRC_MAC for the LAG group
    ...
    ...    19 Verify LAG Hash method as SRC_MAC using traffic.\
    ...    20 Starting traffic.
    ...
    [Tags]       @tcid=AXOS_E72_PARENT-TC-1046    @globalid=2316533    @smoke   @priority=P1
...
#***** 13. Configure LAG Hash method as SRC_MAC for the LAG group *****
    ...
    Wait Until Keyword Succeeds    60 Seconds    5 Seconds    Configure LAG Group Hash Method      n1     ${lag_group}     src-mac
    Wait Until Keyword Succeeds    60 Seconds    5 Seconds    Configure LAG Group Hash Method      n2     ${lag_group}     src-mac

#***** 14. Verify LAG Hash method as SRC_MAC for the LAG group*****

    Wait Until Keyword Succeeds    60 Seconds    5 Seconds    Check Hash Method      n1     ${lag_group}     src-mac
    Wait Until Keyword Succeeds    60 Seconds    5 Seconds    Check Hash Method      n1     ${lag_group}     src-mac
