...
*** Test Cases ***
List_ONT_using_MacAddress
    [Documentation]    List ONT by using MAC address
    [Tags]    @feature=ONT Support    @subFeature=ONT operation support    @author=Doris He    @author=<kkandra> Kumari    @tcid=AXOS_E72_PARENT-TC-487
    Cli   n1    config
    ...
    #Step3: List ONT using MAC Address
    Cli    n1    do show run ont ont-mac-addr ${ONT.ontMACAdd}
    List ONT   n1
