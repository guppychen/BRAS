...
*** Test Cases ***
List_ONT_using_SerialNumber
    [Documentation]    List ONT by using Serial Number
    [Tags]    @feature=ONT Support    @subFeature=ONT operation support    @author=Doris He    @authour=<kkandra> Kumari    @tcid=AXOS_E72_PARENT-TC-486
    Cli   n1   config
    ...
    #List ONT using Serial number
    Cli    n1    do show run ont serial-number ${ONT.ontSerNum}
    List ONT   n1
