*** Settings ***
Documentation     Voice Port with Signaling Type
Resource          ./base.robot
...
*** Test Cases ***
tc_Voice_Port_with_Signaling_Type
    ...
    ...    2. signaling-type selection, dcli potsmgr show pots
    [Tags]       @author=XUAN LI     @TCID=AXOS_E72_PARENT-TC-3455    @globalid=2473212    @priority=P1    @eut=GPON-8r2    @user_interface=CLI
    [Setup]      case setup
    [Teardown]   case teardown
    log    STEP:1. Selection is loopstart or groundstart. Interface pots 211/p1 signaling-type selection, signaling-type selection, show running-config interface pots 211/p1 | detail, dcli potsmgr show pots
