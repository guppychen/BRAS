*** Settings ***
Documentation     Voice Port modification of POTS Holdover Time
Resource          ./base.robot
...
*** Test Cases ***
tc_Voice_Port_modification_of_POTS_Holdover_Time
    ...
    ...    3. Selection is 59 and 65536: interface pots 211/p1 pots-holdover-timer selection command rejected
    [Tags]       @author=XUAN LI     @TCID=AXOS_E72_PARENT-TC-3472    @globalid=2473229    @priority=P1    @eut=GPON-8r2    @user_interface=CLI
    [Setup]      case setup
