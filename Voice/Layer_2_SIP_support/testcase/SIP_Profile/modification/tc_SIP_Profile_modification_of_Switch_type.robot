*** Settings ***
Documentation     SIP Profile modification of Switch type
Resource          ./base.robot
...
*** Test Cases ***
tc_SIP_Profile_modification_of_Switch_type
    ...
    [Tags]       @author=XUAN LI     @TCID=AXOS_E72_PARENT-TC-3402    @globalid=2473159    @priority=P1    @eut=GPON-8r2    @user_interface=CLI
    [Setup]      case setup
    ...
    Wait Until Keyword Succeeds    2min    10sec    check_running_configure    eutA    sip-profile    ${sip_profile}    switch-type=${switch_type_zte}
    ...
    Wait Until Keyword Succeeds    2min    10sec    check_running_configure    eutA    sip-profile    ${sip_profile}    switch-type=${switch_type_huaw}
    ...
    Wait Until Keyword Succeeds    2min    10sec    check_running_configure    eutA    sip-profile    ${sip_profile}    switch-type=${switch_type_syla}
    ...
    Wait Until Keyword Succeeds    2min    10sec    check_running_configure    eutA    sip-profile    ${sip_profile}    switch-type=${switch_type_eric}
    ...
    Wait Until Keyword Succeeds    2min    10sec    check_running_configure    eutA    sip-profile    ${sip_profile}    switch-type=${switch_type_cs2k}
    ...
    Wait Until Keyword Succeeds    2min    10sec    check_running_configure    eutA    sip-profile    ${sip_profile}    switch-type=${switch_type_bell}
