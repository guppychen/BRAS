*** Settings ***
Documentation     SIP Profile modification of Registration Period
Resource          ./base.robot
...
*** Test Cases ***
tc_SIP_Profile_modification_of_Registration_Period
    ...
    [Tags]       @author=XUAN LI     @TCID=AXOS_E72_PARENT-TC-3358    @globalid=2473115    @eut=GPON-8r2    @priority=P1    @user_interface=CLI
    [Setup]      case setup
