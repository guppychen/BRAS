*** Settings ***
Documentation     SIP Profile with RTP Rate Second Order
Resource          ./base.robot
...
*** Test Cases ***
tc_SIP_Profile_with_RTP_Codec_Second_Order
    [Documentation]    1. Enter SIP-Profile rtp-codec second-order = none,ulaw, A-Law, G729, rtp-codec second-order = selection
    [Tags]       @author=XUAN LI     @TCID=AXOS_E72_PARENT-TC-3316    @globalid=2473073    @priority=P1    @eut=GPON-8r2    @user_interface=CLI   
    [Setup]      case setup
    [Teardown]   case teardown
    log    STEP:1. Enter SIP-Profile rtp-codec second-order = none,ulaw, A-Law, G729, rtp-codec second-order = selection
