*** Settings ***
Documentation     DHCP Relay Enabled insert Policy circuit-id %node
Resource          ./base.robot
...
*** Test Cases ***
tc_DHCP_Relay_Enabled_insert_Policy_circuit_id_node
    ...
    [Tags]       @author=Ronnie_Yi     @TCID=AXOS_E72_PARENT-TC-2135    @globalid=2343951    @subfeature=DHCP_Option_82    @feature=DHCPV4    @eut=NGPON2-4    @priority=P1
    [Setup]      case setup
    ...
    check_dhcp_option82_circuit_id    tg1    service_p1    ${shelf}
...
case setup
    ...
    prov_id_profile    eutA    ${id_profile_name}    circuit-id=%Shelf
