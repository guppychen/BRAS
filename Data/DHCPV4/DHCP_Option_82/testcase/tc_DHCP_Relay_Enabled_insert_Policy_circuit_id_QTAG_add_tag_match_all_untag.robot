*** Settings ***
Documentation     DHCP Relay Enabled insert Policy circuit-id %QTAG. add-tag match all untag
Resource          ./base.robot
...
*** Test Cases ***
tc_DHCP_Relay_Enabled_insert_Policy_circuit_id_QTAG_add_tag_match_all_untag
    ...
    [Tags]       @author=Ronnie_Yi     @TCID=AXOS_E72_PARENT-TC-2141    @globalid=2343957    @subfeature=DHCP_Option_82    @feature=DHCPV4    @eut=NGPON2-4    @priority=P1
    [Setup]      case setup
