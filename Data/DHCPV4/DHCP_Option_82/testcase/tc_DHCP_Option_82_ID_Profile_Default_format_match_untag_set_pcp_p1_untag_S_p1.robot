...
*** Test Cases ***
tc_DHCP_Option_82_ID_Profile_Default_format_match_untag_set_pcp_p1_untag_S_p1
    ...
    [Tags]       @author=Ronnie_Yi     @TCID=AXOS_E72_PARENT-TC-2225    @globalid=2344041    @subfeature=DHCP_Option_82    @feature=DHCPV4    @eut=NGPON2-4    @priority=P1    @user_interface=CLI
    [Setup]      case setup
    ...
    create_dhcp_server    tg1    ${server_name}    service_p1    ${server_mac}     ${server_ip}     ${lease_start}    ${stag_vlan}    lease_time=100    ovlan_pbit=${stag_pbit}
