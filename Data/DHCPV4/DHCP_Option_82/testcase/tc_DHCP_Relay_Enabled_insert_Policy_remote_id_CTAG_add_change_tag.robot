*** Settings ***
Documentation     DHCP Relay Enabled insert Policy remote-id %CTAG. add-change-tag
Resource          ./base.robot
...
*** Test Cases ***
tc_DHCP_Relay_Enabled_insert_Policy_remote_id_CTAG_add_change_tag
    ...
    [Tags]       @author=Ronnie_Yi     @TCID=AXOS_E72_PARENT-TC-2177    @globalid=2343993    @subfeature=DHCP_Option_82    @feature=DHCPV4    @eut=NGPON2-4    @priority=P1
    [Setup]      case setup
