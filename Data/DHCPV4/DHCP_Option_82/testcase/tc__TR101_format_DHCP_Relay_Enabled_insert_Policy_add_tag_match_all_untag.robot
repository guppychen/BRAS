*** Settings ***
Documentation     (TR101-format)DHCP Relay Enabled insert Policy . add-tag match all untag
Resource          ./base.robot
...
*** Test Cases ***
tc__TR101_format_DHCP_Relay_Enabled_insert_Policy_add_tag_match_all_untag
    ...
    [Tags]       @author=Ronnie_Yi     @TCID=AXOS_E72_PARENT-TC-2204    @globalid=2344020    @subfeature=DHCP_Option_82    @feature=DHCPV4    @eut=NGPON2-4    @priority=P1    @user_interface=CLI
    [Setup]      case setup
