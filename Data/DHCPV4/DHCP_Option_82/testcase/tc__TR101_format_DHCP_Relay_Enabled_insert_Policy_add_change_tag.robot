*** Settings ***
Documentation     (TR101-format)DHCP Relay Enabled insert Policy . add-change-tag
Resource          ./base.robot
...
*** Test Cases ***
tc__TR101_format_DHCP_Relay_Enabled_insert_Policy_add_change_tag
    ...
    [Tags]       @author=Ronnie_Yi     @TCID=AXOS_E72_PARENT-TC-2206    @globalid=2344022    @subfeature=DHCP_Option_82    @feature=DHCPV4    @eut=NGPON2-4    @priority=P1    @user_interface=CLI
    [Setup]      case setup
