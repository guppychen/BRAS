*** Settings ***
Documentation     DHCP Relay Enabled insert Policy remote-id %CTAG. add-2-tag match all untag
Resource          ./base.robot
...
*** Test Cases ***
tc_DHCP_Relay_Enabled_insert_Policy_remote_id_CTAG_add_2_tag_match_all_untag
    ...
    [Tags]       @author=Ronnie_Yi     @TCID=AXOS_E72_PARENT-TC-2175    @globalid=2343991    @subfeature=DHCP_Option_82    @feature=DHCPV4    @eut=NGPON2-4    @priority=P1
    [Setup]      case setup
    ...
    check_dhcp_option82_remote_id    tg1    service_p1    ${ctag_vlan}
...
case setup
    ...
    prov_id_profile    eutA    ${id_profile_name}    remote-id=%CTag
