...
*** Settings ***
Documentation     Enable mff and dhcp snoop. Provision a service with add 2 tags tag action. Force a client to obtain an IP address. Display snoop table.  -> DHCP client and AR are displayed in the snoop table with inner vlan.
...
*** Test Cases ***
tc_snoop_table_display_add_2_tags
    [Documentation]    Enable mff and dhcp snoop. Provision a service with add 2 tags tag action. Force a client to obtain an IP address. Display snoop table.  -> DHCP client and AR are displayed in the snoop table with inner vlan.
    
    [Tags]     @tcid=AXOS_E72_PARENT-TC-2977    @subFeature=MAC_Forced_Forwarding    @globalid=2434875    @priority=P2   @eut=NGPON2-4    @user_interface=CLI
    [Setup]      AXOS_E72_PARENT-TC-2977 setup
    [Teardown]   AXOS_E72_PARENT-TC-2977 teardown
...
AXOS_E72_PARENT-TC-2977 teardown
