*** Settings ***
Documentation     Provision mff enabled with a snoop entry and no mac. Generate upstream UDP traffic. -> All traffic is forwarded.
Resource          ./base.robot
...
*** Test Cases ***
tc_static_host_no_mac
    [Documentation]    Provision mff enabled with a snoop entry and no mac. Generate upstream UDP traffic. -> All traffic is forwarded.
    [Tags]    @tcid=AXOS_E72_PARENT-TC-1404    @subFeature=MAC_Forced_Forwarding    @globalid=2286173    @priority=P1   @eut=NGPON2-4
    [Setup]      AXOS_E72_PARENT-TC-1404 setup
    [Teardown]   AXOS_E72_PARENT-TC-1404 teardown
    log    STEP:Provision mff enabled with a snoop entry and no mac. Generate upstream UDP traffic. -> All traffic is forwarded.
...
AXOS_E72_PARENT-TC-1404 teardown
