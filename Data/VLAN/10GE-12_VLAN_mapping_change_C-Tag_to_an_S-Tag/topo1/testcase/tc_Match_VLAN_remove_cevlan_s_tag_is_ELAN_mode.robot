...
*** Test Cases ***
tc_Match_VLAN_remove_cevlan_s_tag_is_ELAN_mode
    ...
    ...    4 apply the s-tag in ELAN and policy-map to the uni ethernet port successfully
    ...
    [Tags]    @tcid=AXOS_E72_PARENT-TC-4388    @subFeature=VLAN mapping: change C-Tag to an S-Tag    @globalid=2532644    @priority=P1    @eut=10GE-12    @user_interface=CLI
    ...    @PASS=true
    [Setup]    case setup
    ...
    log    STEP:4 apply the s-tag in ELAN and policy-map to the uni ethernet port successfully
