...
*** Test Cases ***
tc_Match_VLAN_remove_cevlan_s_tag_is_ELINE_mode
    ...
    ...    4 apply the s-tag in ELINE and policy-map to the uni ethernet port successfully
    ...
    [Tags]    @tcid=AXOS_E72_PARENT-TC-4386    @subFeature=VLAN mapping: change C-Tag to an S-Tag    @globalid=2532642    @priority=P1    @eut=10GE-12    @user_interface=CLI
    ...    @PASS=true
    [Setup]    case setup
    ...
    log    STEP:4 apply the s-tag in ELINE and policy-map to the uni ethernet port successfully
