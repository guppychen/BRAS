...
tc_ELAN_between_two_uni_port
    ...
    ...    3	apply the s-tag in ELAN and policy-map to the uni ethernet port1 and port2	successfully
    ...
    [Tags]     @tcid=AXOS_E72_PARENT-TC-4389    @subFeature=VLAN mapping: change C-Tag to an S-Tag    @globalid=2532645    @priority=P1    @eut=10GE-12    @user_interface=CLI    @PASS=true
    [Setup]     case setup
    ...
    log    STEP:3 apply the s-tag in ELAN and policy-map to the uni ethernet port1 and port2 successfully
