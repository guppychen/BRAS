...
*** Test Cases ***
tc_Match_VLAN_translate_cevlan_tag_s_tag_in_ELAN_mode
    [Documentation]
    ...
    ...    4	apply the s-tag in ELAN mode and policy-map to the uni ethernet port	successfully
    ...
    [Tags]     @tcid=AXOS_E72_PARENT-TC-4403      @subFeature=VLAN mapping: Change an S-Tag to another value      @globalid=2532665      @priority=P1      @eut=NGPON2-4    @eut=GPON-8r2    @eut=10GE-12          @user_interface=CLI
    [Setup]     case setup
    ...
    log    STEP:4 apply the s-tag in ELAN mode and policy-map to the uni ethernet port successfully
