...
*** Test Cases ***
tc_Match_VLAN_translate_cevlan_tag
    [Documentation]
    ...
    [Tags]     @tcid=AXOS_E72_PARENT-TC-4397      @subFeature=VLAN mapping: Change an S-Tag to another value      @globalid=2532659      @priority=P1      @eut=NGPON2-4    @eut=GPON-8r2    @eut=10GE-12          @user_interface=CLI
    [Setup]     case setup
