...
*** Test Cases ***
tc_Match_any_add_s_tag_upstream_is_untag
    ...
    ...    6	send untag upstream traffic to ont1 with SMAC 000001000001 DMAC 000002000002;	eth-port1 can pass the upstream traffic; only client1 can receive the downstream traffic;

    [Tags]    @author=AnneLI    @globalid=2298735    @tcid=AXOS_E72_PARENT-TC-625    @eut=NGPON2-4    @priority=P2
    [Setup]    setup
    ...
    log    step6: send ethertype 0x9100 upstream traffic to ${interface_type2} ${service_model.subscriber_point1.name} with SMAC ${mac1} DMAC ${mac2};
