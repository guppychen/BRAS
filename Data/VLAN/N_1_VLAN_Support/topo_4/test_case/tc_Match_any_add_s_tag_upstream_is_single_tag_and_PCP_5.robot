...
*** Test Cases ***
tc_Match_any_add_s_tag_upstream_is_single_tag_and_PCP_5
    ...
    ...    6	send PCP=5 upstream traffic to ont1 with SMAC 000001000001 DMAC 000002000002;
    [Tags]    @author=AnneLI    @globalid=2298736    @tcid=AXOS_E72_PARENT-TC-626    @eut=NGPON2-4    @priority=P2
    [Setup]    setup
    ...
    log    step6: send pcp=5 upstream traffic to ${interface_type2} ${service_model.subscriber_point1.name} with SMAC ${mac1} DMAC ${mac2};
    Tg Create single Tagged Stream On Port    tg1    raw_upstream1    p1    p2      vlan_id=${vlan_2}    vlan_user_priority=${pcp_2}    frame_size=512
