...
*** Test Cases ***
tc_Multi_flows_in_one_class_map_un_matched_downstream
    ...
    [Tags]    @author=AnneLI    @globalid=2298761    @tcid=AXOS_E72_PARENT-TC-651     @eut=NGPON2-4    @priority=P2
    [Setup]    setup
    log    step5: send double-tagged S=${service_vlan} C=${match_vlan} and S=${service_vlan} C=${match_vlan_3} downstream traffics to ${interface_type2} ${service_model.subscriber_point1.name} ;
