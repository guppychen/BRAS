...
*** Test Cases ***
tc_Unmatch_priority_tag_add_s_tag
    ...
    ...    5	send priority-tag 1 upstream traffic to ont1	no eth-port can pass the upstream traffic

    [Tags]    @author=AnneLI    @globalid=2298749    @tcid=AXOS_E72_PARENT-TC-639     @eut=NGPON2-4    @priority=P2
    [Setup]    setup
...
setup
    ...
    log    step1:create a class-map to match priority-tag ${match_pcp_1} in flow ${flow_index}
