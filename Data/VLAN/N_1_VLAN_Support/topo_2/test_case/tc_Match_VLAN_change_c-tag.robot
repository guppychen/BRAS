...
tc_Match_VLAN_change_c_tag
    ...
    ...    5	send VLAN 10 upstream traffic to ont1 with SMAC 000001000001 DMAC 000002000002;
    ...    6	send single-tagged downstream traffic to eth-port1 with SMAC 000002000002 DMAC 00000100000
    [Tags]    @author=AnneLI    @globalid=2298723      @tcid=AXOS_E72_PARENT-TC-613     @eut=NGPON2-4    @priority=P1
    [Setup]    setup
    ...
    log    step6: send single-tagged downstream traffic to ${interface_type1} ${service_model.service_point1.member.interface1} with SMAC ${mac2} DMAC ${mac1};
    Tg Create single Tagged Stream On Port    tg1    raw_downstream1    p2    p1      vlan_id=${service_vlan}    vlan_user_priority=0
...
setup
     ...
     subscriber_point_add_svc    subscriber_point1      ${match_vlan}       ${service_vlan}         cevlan_action=remove-cevlan
