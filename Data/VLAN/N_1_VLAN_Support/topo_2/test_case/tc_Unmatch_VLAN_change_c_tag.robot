...
tc_Unmatch_VLAN_change_c_tag
    ...
    ...    5	send VLAN 20 upstream traffic to ont1
    [Tags]    @author=AnneLI    @globalid=2298745      @tcid=AXOS_E72_PARENT-TC-635     @eut=NGPON2-4    @priority=P2
    [Setup]    setup
