...
tc_Match_vlan_add_s_tag
    ...
    [Tags]    @author=AnneLI    @globalid=2298721      @tcid=AXOS_E72_PARENT-TC-611       @eut=NGPON2-4    @priority=P1
    [Setup]    setup
    log    step5: send VLAN ${match_vlan} upstream traffic to ${service_model.subscriber_point1.name} with SMAC ${mac1} DMAC ${mac2};
    ...
    verify_traffic_loss_within_with_filter    tg1    raw_upstream1    p3    eth.src==${mac1} and eth.dst==${mac2}    ${error_rate}
