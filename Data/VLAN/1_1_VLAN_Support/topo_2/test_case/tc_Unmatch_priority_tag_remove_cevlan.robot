...
*** Test Cases ***
tc_Unmatch_priority_tag_remove_cevlan
    ...
    [Tags]    @globalid=2318814    @tcid=AXOS_E72_PARENT-TC-1169    @eut=NGPON2-4    @priority=P2
    [Setup]    setup
    log    step5: send single tagged upstream traffic to ${service_model.subscriber_point1.attribute.interface_type} ${service_model.subscriber_point1.name} with SMAC ${mac1} DMAC ${mac2};
