...
*** Test Cases ***
tc_Match_any_upstream_is_priority_tag
    ...
    [Tags]    @globalid=2318794    @tcid=AXOS_E72_PARENT-TC-1149    @eut=NGPON2-4    @priority=P1
    [Setup]    setup
    log    step5: send priority tagged upstream traffic to ${service_model.subscriber_point1.name} with SMAC ${mac1} DMAC ${mac2};
    ...
    clear_interface_counters    eutA    ${service_model.service_point2.attribute.interface_type}    ${service_model.service_point2.member.interface1}
    ...
    show_interface_counters    eutA    ${service_model.service_point2.attribute.interface_type}    ${service_model.service_point2.member.interface1}
    ...
    log    step6: send downstream traffic with (${service_vlan};${cvlan_one2one_1};0) into ${service_model.service_point1.member.interface1} with SMAC ${mac2} DMAC ${mac1};
