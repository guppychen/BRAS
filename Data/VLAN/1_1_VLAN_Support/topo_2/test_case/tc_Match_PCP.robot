...
tc_Match_PCP
    ...
    [Tags]    @globalid=2318782    @tcid=AXOS_E72_PARENT-TC-1137    @eut=NGPON2-4    @priority=P1
    [Setup]    setup
    log    step5: send single-tagged PCP ${match_pcp_1} upstream traffic to ${service_model.subscriber_point1.attribute.interface_type} ${service_model.subscriber_point1.name} with SMAC ${mac1} DMAC ${mac2};
