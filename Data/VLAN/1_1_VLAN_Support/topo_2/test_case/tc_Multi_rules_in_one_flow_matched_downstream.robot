...
tc_Multi_rules_in_one_flow_matched_downstream
    ...
    ...    5    send downstream traffic with (100;10) into eth-port1

    [Tags]    @globalid=2318807    @tcid=AXOS_E72_PARENT-TC-1162    @eut=NGPON2-4    @priority=P2
    [Setup]    setup
    log    setup5 send downstream traffic with (100;10) into eth-port1
