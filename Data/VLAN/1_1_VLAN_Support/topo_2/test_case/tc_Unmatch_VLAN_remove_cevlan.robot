...
tc_Unmatch_VLAN_remove_cevlan
    ...
    ...    5.send unmatched single-tagged upstream traffic to ONT1
    [Tags]    @globalid=2318792    @tcid=AXOS_E72_PARENT-TC-1147    @eut=NGPON2-4    @priority=P2
    [Setup]    setup
    log    step5: send unmatched single-tagged upstream traffic to ${service_model.subscriber_point1.attribute.interface_type} ${service_model.subscriber_point1.name} with SMAC ${mac1} DMAC ${mac2};
