...
*** Test Cases ***
tc_Multi_S-VLANs_under_an_ont-port_unmatched_downstream
    ...
    ...    5    send downstream traffic with (100;20) and (200;10) into eth-port1

    [Tags]    @globalid=2318800    @tcid=AXOS_E72_PARENT-TC-1155    @eut=NGPON2-4    @priority=P2
    [Setup]    setup
    log    step5:send downstream traffic with (100;20) and (200;10) into eth-port1
    ...
    ...    vlan_id_outer=${cvlan_one2one_1}    vlan_outer_user_priority=0    vlan_id=${match_vlan_2}    vlan_user_priority=0    frame_size=512    length_mode=fixed
