...
tc_Unmatch_src_oui
    ...
    ...    5.send unmatched src-oui upstream traffic to ont1
    [Tags]    @globalid=2318818    @tcid=AXOS_E72_PARENT-TC-1173    @eut=NGPON2-4    @priority=P2
    [Setup]    setup
    log    step5: send unmatched src-oui upstream traffic to ${service_model.subscriber_point1.attribute.interface_type} ${service_model.subscriber_point1.name}
