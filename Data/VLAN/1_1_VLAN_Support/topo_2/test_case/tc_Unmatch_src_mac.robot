...
tc_Unmatch_src_mac
    ...
    ...    5.send unmatched src-mac upstream traffic to ont1
    [Tags]    @globalid=2318817    @tcid=AXOS_E72_PARENT-TC-1172    @eut=NGPON2-4    @priority=P2
    [Setup]    setup
    log    step5: send unmatched src-mac upstream traffic to ${service_model.subscriber_point1.attribute.interface_type} ${service_model.subscriber_point1.name}
