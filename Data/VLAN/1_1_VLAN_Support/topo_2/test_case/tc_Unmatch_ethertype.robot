...
tc_Unmatch_ethertype
    ...
    ...    5.send unmatch ethertype upstream traffic to ont1
    [Tags]    @globalid=2318819    @tcid=AXOS_E72_PARENT-TC-1174    @eut=NGPON2-4    @priority=P2
    [Setup]    setup
    log    step5: send unmatch ethertype upstream traffic to ${service_model.subscriber_point1.attribute.interface_type} ${service_model.subscriber_point1.name}
