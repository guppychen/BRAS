...
*** Test Cases ***
tc_Multi_S-VLANs_under_an_ont-port_matched_upstream
    ...
    ...    5    send single-tagged upstream traffic to ONT

    [Tags]    @globalid=2318797    @tcid=AXOS_E72_PARENT-TC-1152    @eut=NGPON2-4    @priority=P2
    [Setup]    setup
    ...
    verify_traffic_loss_within_with_filter    tg1    raw_upstream2    p1    eth.src==${mac3} and eth.dst==${mac4} and vlan.id==${service_vlan_2} and vlan.id==${cvlan_one2one_2} and vlan.id==${match_vlan_2} and vlan.priority ==0 and vlan.priority ==0 and vlan.priority ==0    ${error_rate}
    verify_traffic_loss_within_with_filter    tg1    raw_upstream2    p3    eth.src==${mac3} and eth.dst==${mac4} and vlan.id==${service_vlan_2} and vlan.id==${cvlan_one2one_2} and vlan.id==${match_vlan_2} and vlan.priority ==0 and vlan.priority ==0 and vlan.priority ==0    ${error_rate}
