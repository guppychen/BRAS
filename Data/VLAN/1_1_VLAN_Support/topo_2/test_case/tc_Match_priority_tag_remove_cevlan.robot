...
*** Test Cases ***
tc_Match_priority_tag_remove_cevlan
    ...
    [Tags]    @globalid=2318791    @tcid=AXOS_E72_PARENT-TC-1146    @eut=NGPON2-4    @priority=P1
    [Setup]    setup
    log    step5: send priority-tagged VLAN ${match_vlan_3} upstream traffic to ${service_model.subscriber_point1.attribute.interface_type} ${service_model.subscriber_point1.name} with SMAC ${mac1} DMAC ${mac2};
