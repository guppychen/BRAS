...
*** Test Cases ***
tc_One2one_vlan_for_G8032
    [Documentation]    1 set vlan 100 mode as one2one and enable mac learning on E7-A and E7-B
    ...    2 provision G8032 between two E7s;
    ...    3 add vlan 100 to G8032 ports on both E7s; add uplink to vlan 100 on E7-B
    ...    4 send unstream and downstream traffics
    ...    5 switch the G8032 ring
    [Tags]    @tcid=AXOS_E72_PARENT-TC-1177    @globalid=2318822    @priority=P2    @eut=NGPON2-4
    [Setup]    case setup
    ...
    shutdown_port    eutA    ${service_model.service_point1.attribute.interface_type}    ${service_model.service_point1.member.interface2}
    ...
    TG Verify Traffic Loss For Stream Is Within    tg1    upstream    ${G8032_max_second_for_switch}
    TG Verify Traffic Loss For Stream Is Within    tg1    downstream    ${G8032_max_second_for_switch}
