...
*** Test Cases ***
tc_One2one_vlan_for_LAG
    [Documentation]    1 set vlan 100 mode as one2one and enable mac learning on E7-A and E7-B
    ...    2 provision LAG between two E7s;
    ...    3 add vlan 100 to LAG ports on both E7s; add uplink to vlan 100 on E7-B
    ...    4 send unstream and downstream traffics
    ...    5 switch the LAG
    [Tags]    @tcid=AXOS_E72_PARENT-TC-1134    @globalid=2318779    @priority=P2    @eut=NGPON2-4
    [Setup]    case setup
    ...
    TG Verify Traffic Loss For Stream Is Within    tg1    upstream    ${LAG_max_second_for_switch}
    TG Verify Traffic Loss For Stream Is Within    tg1    downstream    ${LAG_max_second_for_switch}
