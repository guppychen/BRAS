...
*** Test Cases ***
tc_svc_tag_actoin_basic_test_21
    [Documentation]    match rule:
    ...
    ...    Action:tagged: match vlan + p-bit
    ...    add-tag + p-bit copy
    [Tags]    @run=3.1.2    @author=Wanlin Sun     @tcid=AXOS_E72_PARENT-TC-1206    @feature=VLAN    @subfeature=VLAN_Tag_Manipulation
    ...     @globalid=2318859    @eut=NGPON2-4    @priority=P1
    [Setup]      AXOS_E72_PARENT-TC-1206 setup
    [Teardown]   AXOS_E72_PARENT-TC-1206 teardown
    ...
    ${p1_cap}    generate_pcap_name    basic_test_21
...
*** Keywords ***
AXOS_E72_PARENT-TC-1206 setup
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-1206 setup
    log    create vlan
...
AXOS_E72_PARENT-TC-1206 teardown
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-1206 teardown
