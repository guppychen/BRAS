...
*** Test Cases ***
tc_svc_tag_actoin_basic_test_15
    [Documentation]    match rule:
    ...    tagged: only match vlan, p-bit any
    ...    Action:change-tag + set p-bit
    ...
    [Tags]       @author=Wanlin Sun     @tcid=AXOS_E72_PARENT-TC-1200    @feature=VLAN    @subfeature=VLAN_Tag_Manipulation
    ...     @globalid=2318853    @eut=NGPON2-4    @priority=P1
    [Setup]      AXOS_E72_PARENT-TC-1200 setup
    [Teardown]   AXOS_E72_PARENT-TC-1200 teardown
    ...
    ${p1_cap}    generate_pcap_name    basic_test_15
...
*** Keywords ***
AXOS_E72_PARENT-TC-1200 setup
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-1200 setup
    log    create vlan
...
AXOS_E72_PARENT-TC-1200 teardown
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-1200 teardown
