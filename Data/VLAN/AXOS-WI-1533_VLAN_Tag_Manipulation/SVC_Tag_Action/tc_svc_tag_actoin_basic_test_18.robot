...
...    add-and-change+set p-bit(use-p-bit + use-inner-pbit)
Resource          ./base.robot
...
*** Test Cases ***
tc_svc_tag_actoin_basic_test_18
    [Documentation]    match rule:
    ...    tagged: only match vlan, p-bit any
    ...    Action:
    ...    add-and-change+set p-bit(use-p-bit + use-inner-pbit)
    [Tags]       @author=Wanlin Sun     @tcid=AXOS_E72_PARENT-TC-1203    @feature=VLAN    @subfeature=VLAN_Tag_Manipulation
    ...     @globalid=2318856    @eut=NGPON2-4    @priority=P1
    [Setup]      AXOS_E72_PARENT-TC-1203 setup
    [Teardown]   AXOS_E72_PARENT-TC-1203 teardown
    ...
    ${p1_cap}    generate_pcap_name    basic_test_18
...
*** Keywords ***
AXOS_E72_PARENT-TC-1203 setup
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-1203 setup
    log    create vlan
...
AXOS_E72_PARENT-TC-1203 teardown
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-1203 teardown
