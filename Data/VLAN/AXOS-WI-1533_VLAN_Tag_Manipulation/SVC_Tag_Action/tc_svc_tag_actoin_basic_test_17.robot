...
*** Test Cases ***
tc_svc_tag_actoin_basic_test_17
    [Documentation]    match rule:
    ...    tagged: only match vlan, p-bit any
    ...    Action:add-and-change+set p-bit(use-p-bit)
    ...
    [Tags]       @author=Wanlin Sun     @tcid=AXOS_E72_PARENT-TC-1202    @feature=VLAN    @subfeature=VLAN_Tag_Manipulation
    ...     @globalid=2318855    @eut=NGPON2-4    @priority=P1
    [Setup]      AXOS_E72_PARENT-TC-1202 setup
    [Teardown]   AXOS_E72_PARENT-TC-1202 teardown
    ...
    ${p1_cap}    generate_pcap_name    basic_test_17
...
*** Keywords ***
AXOS_E72_PARENT-TC-1202 setup
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-1202 setup
    log    create vlan
...
AXOS_E72_PARENT-TC-1202 teardown
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-1202 teardown
