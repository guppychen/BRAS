...
*** Test Cases ***
tc_svc_tag_actoin_basic_test_7
    [Documentation]    match rule:
    ...    untagged: src-mac + src-mac-mask
    ...    Action:
    ...    add-tag and set p-bit
    [Tags]       @author=Wanlin Sun     @tcid=AXOS_E72_PARENT-TC-1192    @feature=VLAN    @subfeature=VLAN_Tag_Manipulation
    ...     @globalid=2318845    @eut=NGPON2-4    @priority=P1
    [Setup]      AXOS_E72_PARENT-TC-1192 setup
    [Teardown]   AXOS_E72_PARENT-TC-1192 teardown
    ...
    ${p1_cap}    generate_pcap_name    basic_test_7
...
*** Keywords ***
AXOS_E72_PARENT-TC-1192 setup
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-1192 setup
    log    create vlan
...
AXOS_E72_PARENT-TC-1192 teardown
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-1192 teardown
