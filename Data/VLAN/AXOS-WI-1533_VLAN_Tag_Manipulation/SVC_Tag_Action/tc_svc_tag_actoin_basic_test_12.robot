...
...    Action:
...    add2tag + set p-bit(use-p-bit+ use-inner-pbit)
Resource          ./base.robot
...
*** Test Cases ***
tc_svc_tag_actoin_basic_test_12
    [Documentation]    match rule:
    ...    untagged: src-mac + src-mac-mask+ethtype
    ...    Action:
    ...    add2tag + set p-bit(use-p-bit+ use-inner-pbit)
    [Tags]       @author=Wanlin Sun     @tcid=AXOS_E72_PARENT-TC-1197    @feature=VLAN    @subfeature=VLAN_Tag_Manipulation
    ...     @globalid=2318849    @eut=NGPON2-4    @priority=P1
    [Setup]      AXOS_E72_PARENT-TC-1197 setup
    [Teardown]   AXOS_E72_PARENT-TC-1197 teardown
    log    STEP:Action:add2tag + set p-bit(use-p-bit+ use-inner-pbit)
    ...
    ${p1_cap}    generate_pcap_name    basic_test_12
...
*** Keywords ***
AXOS_E72_PARENT-TC-1197 setup
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-1197 setup
    log    create vlan
    prov_vlan    eutA    ${p_data_vlan1}
    log    service_point_add_vlan for uplink service
    service_point_add_vlan    service_point_list1    ${p_data_vlan1}

AXOS_E72_PARENT-TC-1197 teardown
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-1197 teardown
