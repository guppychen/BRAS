...
*** Test Cases ***
tc_svc_tag_action_combination_test_9
    [Documentation]    combination of the 3 actions. The 3 services use different s-tag:
    ...    1. match rules: untagged: src-mac any, src-mac-mask any,ethertype any;
    ...    action: add2tags+set p-bit(use-p-bit)
    ...    2. match rules: tagged: match vlan + p-bit
    ...
    ...    3. match rules: tagged: match vlan + p-bit
    ...    action: change-tag + set p-bit
    [Tags]       @author=Wanlin Sun     @tcid=AXOS_E72_PARENT-TC-1222    @feature=VLAN    @subfeature=VLAN_Tag_Manipulation
    ...     @globalid=2318875    @eut=NGPON2-4    @priority=P1
    [Setup]      AXOS_E72_PARENT-TC-1222 setup
    [Teardown]   AXOS_E72_PARENT-TC-1222 teardown
    ...
    ...    set-stag-pcp=${stag_pcp}    cfg_prefix=v3
    ...
    ${p1_cap}    generate_pcap_name    combination_test_9
...
*** Keywords ***
AXOS_E72_PARENT-TC-1222 setup
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-1222 setup
...
AXOS_E72_PARENT-TC-1222 teardown
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-1222 teardown
