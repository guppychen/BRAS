...
*** Test Cases ***
tc_svc_tag_actoin_basic_test_19
    [Documentation]    match rule:
    ...    tagged: only match vlan, p-bit any
    ...    Action:
    ...    add-and-change+copy p-bit
    [Tags]    @run=3.1.2    @author=Wanlin Sun     @TCID=AXOS_E72_PARENT-TC-1204    @feature=VLAN    @subfeature=VLAN_Tag_Manipulation
    ...     @globalid=2318857    @eut=NGPON2-4    @priority=P1
    [Setup]      AXOS_E72_PARENT-TC-1204 setup
    [Teardown]   AXOS_E72_PARENT-TC-1204 teardown
    ...
    ${p1_cap}    generate_pcap_name    basic_test_19
...
*** Keywords ***
AXOS_E72_PARENT-TC-1204 setup
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-1204 setup
    log    create vlan
...
AXOS_E72_PARENT-TC-1204 teardown
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-1204 teardown
