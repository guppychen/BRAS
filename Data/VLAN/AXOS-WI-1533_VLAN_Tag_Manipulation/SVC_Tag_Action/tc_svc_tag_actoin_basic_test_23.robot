...
*** Test Cases ***
tc_svc_tag_actoin_basic_test_23
    [Documentation]    match rule:
    ...    tagged: match vlan + p-bit
    ...    Action:change-tag + set p-bit
    ...
    [Tags]    @run=3.1.2    @author=Wanlin Sun     @tcid=AXOS_E72_PARENT-TC-1208    @feature=VLAN    @subfeature=VLAN_Tag_Manipulation
    ...     @globalid=2318861    @eut=NGPON2-4    @priority=P1
    [Setup]      AXOS_E72_PARENT-TC-1208 setup
    [Teardown]   AXOS_E72_PARENT-TC-1208 teardown
    log    STEP:Action:change-tag + set p-bit
    &{result}    subscriber_point_add_svc    subscriber_point1    ${p_match_vlan1}    ${p_data_vlan1}    cevlan_action=remove-cevlan    set-stag-pcp=promote
    ...
    Tg Create Single Tagged Stream On Port    tg1    ds_match_vlan    subscriber_p1    service_p1    ${p_data_vlan1}    0
    ...
    ${p1_cap}    generate_pcap_name    basic_test_23
...
*** Keywords ***
AXOS_E72_PARENT-TC-1208 setup
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-1208 setup
    log    create vlan
...
AXOS_E72_PARENT-TC-1208 teardown
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-1208 teardown
