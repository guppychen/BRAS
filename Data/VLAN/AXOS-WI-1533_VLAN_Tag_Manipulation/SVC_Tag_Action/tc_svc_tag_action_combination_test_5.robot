...
*** Test Cases ***
tc_svc_tag_action_combination_test_5
    [Documentation]    combination of the 3 actions. The 3 services use different s-tag:
    ...    1. match rules: untagged src-mac any+src-mac-mask+ethertype any;
    ...    action: add2tags+set p-bit(use-p-bit + use-inner-p-bit)
    ...    2. match rules: tagged only match vlan + pbit any
    ...
    ...    3. match rules: tagged only match vlan+p-bit any
    ...    action: add-and-change+copy p-bit
    [Tags]       @author=Wanlin Sun     @tcid=AXOS_E72_PARENT-TC-1218    @feature=VLAN    @subfeature=VLAN_Tag_Manipulation
    ...     @globalid=2318871    @eut=NGPON2-4    @priority=P1
    [Setup]      AXOS_E72_PARENT-TC-1218 setup
    [Teardown]   AXOS_E72_PARENT-TC-1218 teardown
    ...
    ...    cevlan_action=translate-cevlan-tag	cevlan=${p_ce_add_vlan1}    set-stag-pcp=promote
    ...
    ${p1_cap}    generate_pcap_name    combination_test_5
...
*** Keywords ***
AXOS_E72_PARENT-TC-1218 setup
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-1218 setup
...
AXOS_E72_PARENT-TC-1218 teardown
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-1218 teardown
