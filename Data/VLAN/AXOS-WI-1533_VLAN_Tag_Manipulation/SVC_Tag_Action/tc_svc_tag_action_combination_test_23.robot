...
*** Test Cases ***
tc_svc_tag_action_combination_test_23
    [Documentation]    combination of the 2 actions. The 2 services use different s-tag:
    ...    1. match rules:untagged: src-mac any,src-mac-mask any,ethertype any;
    ...    action: add2tags+set p-bit(use-p-bit + use-inner-p-bit);
    ...    2. match rules: tagged: match vlan + p-bit;
    ...    action: add-and-change+copy p-bit;
    [Tags]       @author=Wanlin Sun     @tcid=AXOS_E72_PARENT-TC-1236    @feature=VLAN    @subfeature=VLAN_Tag_Manipulation
    ...     @globalid=2318889    @eut=NGPON2-4    @priority=P1
    [Setup]      AXOS_E72_PARENT-TC-1236 setup
    [Teardown]   AXOS_E72_PARENT-TC-1236 teardown
    ...
    ${p1_cap}    generate_pcap_name    combination_test_23
...
*** Keywords ***
AXOS_E72_PARENT-TC-1236 setup
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-1236 setup
...
AXOS_E72_PARENT-TC-1236 teardown
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-1236 teardown
