...
*** Test Cases ***
tc_svc_tag_actoin_basic_test_4
    [Documentation]    match rule:
    ...    untagged: src-mac
    ...    Action:
    ...    add-tag and set p-bit
    [Tags]       @author=Wanlin Sun     @tcid=AXOS_E72_PARENT-TC-1189    @feature=VLAN    @subfeature=VLAN_Tag_Manipulation
    ...     @globalid=2318842    @eut=NGPON2-4    @priority=P1
    [Setup]      AXOS_E72_PARENT-TC-1189 setup
    [Teardown]   AXOS_E72_PARENT-TC-1189 teardown
    ...
    log    STEP:match rule:untagged: src-mac
    ...
    ${p1_cap}    generate_pcap_name    basic_test_4
...
*** Keywords ***
AXOS_E72_PARENT-TC-1189 setup
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-1189 setup
    log    create vlan
...
AXOS_E72_PARENT-TC-1189 teardown
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-1189 teardown
