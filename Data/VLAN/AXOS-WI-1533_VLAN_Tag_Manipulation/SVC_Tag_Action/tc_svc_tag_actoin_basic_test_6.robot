...
*** Test Cases ***
tc_svc_tag_actoin_basic_test_6
    [Documentation]    match rule:
    ...    untagged: src-mac
    ...    Action:
    ...    add2tag and set p-bit(use-p-bit+use-inner-pbit)
    [Tags]       @author=Wanlin Sun     @tcid=AXOS_E72_PARENT-TC-1191    @feature=VLAN    @subfeature=VLAN_Tag_Manipulation
    ...     @globalid=2318844    @eut=NGPON2-4    @priority=P1
    [Setup]      AXOS_E72_PARENT-TC-1191 setup
    [Teardown]   AXOS_E72_PARENT-TC-1191 teardown
    ...
    ${p1_cap}    generate_pcap_name    basic_test_6
...
*** Keywords ***
AXOS_E72_PARENT-TC-1191 setup
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-1191 setup
    log    create vlan
...
AXOS_E72_PARENT-TC-1191 teardown
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-1191 teardown
