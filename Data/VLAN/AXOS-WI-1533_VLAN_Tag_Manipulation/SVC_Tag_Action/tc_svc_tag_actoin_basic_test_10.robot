...
...    untagged: src-mac + src-mac-mask+ethtype
...    Action:
...    add-tag + set p-bit
Resource          ./base.robot
...
*** Test Cases ***
tc_svc_tag_actoin_basic_test_10
    [Documentation]    match rule:
    ...    untagged: src-mac + src-mac-mask+ethtype
    ...    Action:
    ...    add-tag + set p-bit
    [Tags]       @author=Wanlin Sun     @tcid=AXOS_E72_PARENT-TC-1195    @feature=VLAN    @subfeature=VLAN_Tag_Manipulation
    ...     @globalid=2318848    @eut=NGPON2-4    @priority=P1
    [Setup]      AXOS_E72_PARENT-TC-1195 setup
    [Teardown]   AXOS_E72_PARENT-TC-1195 teardown
    log    STEP:Action:add-tag + set p-bit
    &{result}    subscriber_point_add_svc    subscriber_point1    untagged    ${p_data_vlan1}    set-stag-pcp=${stag_pcp}
    log    STEP:match rule:untagged: src-mac + src-mac-mask+ethtype
    ...
    prov_class_map     eutA    &{result}[classmap]    ethernet    flow    1    3    ethertype=${ethertype_hex}
    ...
    ${p1_cap}    generate_pcap_name    basic_test_10
...
*** Keywords ***
AXOS_E72_PARENT-TC-1195 setup
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-1195 setup
    log    create vlan
    prov_vlan    eutA    ${p_data_vlan1}
    log    service_point_add_vlan for uplink service
    service_point_add_vlan    service_point_list1    ${p_data_vlan1}

AXOS_E72_PARENT-TC-1195 teardown
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-1195 teardown
