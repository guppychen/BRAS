...
*** Test Cases ***
tc_svc_tag_action_combination_test_13
    [Documentation]    combination of the 3 actions. The 3 services use different s-tag:
    ...    1. match rules: untagged: src-mac + src-mac-mask + ethtype;
    ...    action: add-tag + set p-bit
    ...    2. match rules: tagged: only match vlan, p-bit any
    ...
    ...    3. match rules: tagged: match vlan + p-bit
    ...    action: add-tag + set p-bit
    [Tags]       @author=Wanlin Sun     @tcid=AXOS_E72_PARENT-TC-1226    @feature=VLAN    @subfeature=VLAN_Tag_Manipulation
    ...     @globalid=2318879    @eut=NGPON2-4    @priority=P1
    [Setup]      AXOS_E72_PARENT-TC-1226 setup
    [Teardown]   AXOS_E72_PARENT-TC-1226 teardown
    ...
    ${p1_cap}    generate_pcap_name    combination_test_13
...
*** Keywords ***
AXOS_E72_PARENT-TC-1226 setup
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-1226 setup
...
AXOS_E72_PARENT-TC-1226 teardown
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-1226 teardown
