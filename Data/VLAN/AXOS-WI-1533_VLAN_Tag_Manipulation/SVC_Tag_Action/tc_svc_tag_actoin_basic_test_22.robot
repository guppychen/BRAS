...
*** Test Cases ***
tc_svc_tag_actoin_basic_test_22
    [Documentation]    match rule:
    ...    tagged: match vlan + p-bit
    ...    Action:change-tag + set p-bit
    ...
    [Tags]       @author=Wanlin Sun     @tcid=AXOS_E72_PARENT-TC-1207    @feature=VLAN    @subfeature=VLAN_Tag_Manipulation
    ...     @globalid=2318860    @eut=NGPON2-4    @priority=P1
    [Setup]      AXOS_E72_PARENT-TC-1207 setup
    [Teardown]   AXOS_E72_PARENT-TC-1207 teardown
    log    STEP:Action:change-tag + set p-bit
    &{result}    subscriber_point_add_svc    subscriber_point1    ${p_match_vlan1}    ${p_data_vlan1}    cevlan_action=remove-cevlan    set-stag-pcp=${stag_pcp}
    ...
    ${p1_cap}    generate_pcap_name    basic_test_22
...
*** Keywords ***
AXOS_E72_PARENT-TC-1207 setup
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-1207 setup
    log    create vlan
...
AXOS_E72_PARENT-TC-1207 teardown
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-1207 teardown
