...
*** Test Cases ***
tc_svc_tag_actoin_basic_test_20
    [Documentation]    match rule:
    ...    tagged: only match vlan + p-bit
    ...    Action:
    ...    add-tag and set p-bit
    [Tags]       @author=Wanlin Sun     @tcid=AXOS_E72_PARENT-TC-1205    @feature=VLAN    @subfeature=VLAN_Tag_Manipulation
    ...     @globalid=2318858    @eut=NGPON2-4    @priority=P1
    [Setup]      AXOS_E72_PARENT-TC-1205 setup
    [Teardown]   AXOS_E72_PARENT-TC-1205 teardown
    ...
    ${p1_cap}    generate_pcap_name    basic_test_20
...
*** Keywords ***
AXOS_E72_PARENT-TC-1205 setup
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-1205 setup
    log    create vlan
    prov_vlan    eutA    ${p_data_vlan1}
    log    service_point_add_vlan for uplink service
    service_point_add_vlan    service_point_list1    ${p_data_vlan1}

AXOS_E72_PARENT-TC-1205 teardown
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-1205 teardown
