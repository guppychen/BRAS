...
*** Test Cases ***
tc_svc_tag_actoin_basic_test_27
    [Documentation]    match rule:
    ...    tagged: only match p-bit, ignore vlan
    ...    Action:
    ...    add-tag + set p-bit
    [Tags]       @author=Wanlin Sun     @tcid=AXOS_E72_PARENT-TC-1212    @feature=VLAN    @subfeature=VLAN_Tag_Manipulation
    ...     @globalid=2318865    @eut=NGPON2-4    @priority=P1
    [Setup]      AXOS_E72_PARENT-TC-1212 setup
    [Teardown]   AXOS_E72_PARENT-TC-1212 teardown
    ...
    ${p1_cap}    generate_pcap_name    basic_test_27
...
*** Keywords ***
AXOS_E72_PARENT-TC-1212 setup
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-1212 setup
    prov_vlan    eutA    ${p_data_vlan1}
    log    service_point_add_vlan for uplink service
    service_point_add_vlan    service_point_list1    ${p_data_vlan1}

AXOS_E72_PARENT-TC-1212 teardown
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-1212 teardown
