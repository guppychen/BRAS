...
*** Test Cases ***
tc_svc_tag_actoin_basic_test_1
    [Documentation]    match rule:
    ...    untagged: src-mac any, src-mac-mask any,ethertype any.
    ...    Action:
    ...    add-tag and set p-bit
    [Tags]    @author=Wanlin Sun    @tcid=AXOS_E72_PARENT-TC-1186    @feature=VLAN    @subfeature=VLAN_Tag_Manipulation    @globalid=2318839    @eut=NGPON2-4
    ...    @priority=P1
    [Setup]    AXOS_E72_PARENT-TC-1186 setup
    ...
    prov_class_map    eutA    &{result}[classmap]    ethernet    flow    1    1
    ...    untagged=${EMPTY}
    ...
    ${p1_cap}    generate_pcap_name    basic_test_1
    ...
    [Teardown]    AXOS_E72_PARENT-TC-1186 teardown

*** Keywords ***
AXOS_E72_PARENT-TC-1186 setup
    log    Enter AXOS_E72_PARENT-TC-1186 setup
    log    create vlan
    prov_vlan    eutA    ${p_data_vlan1}
    log    service_point_add_vlan for uplink service
    service_point_add_vlan    service_point_list1    ${p_data_vlan1}

AXOS_E72_PARENT-TC-1186 teardown
    log    Enter AXOS_E72_PARENT-TC-1186 teardown
