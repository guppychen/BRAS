...
*** Test Cases ***
tc_svc_tag_action_combination_test_7
    [Documentation]    combination of the 3 actions. The 3 services use different s-tag:
    ...    1. match rules: untagged src-mac any+src-mac-mask+ethertype any;
    ...    action: add-tag + set p-bit
    ...    2. match rules: tagged: match vlan + p-bit
    ...
    ...    3. match rules: tagged: match vlan + p-bit
    ...    action: add-tag + p-bit copy
    [Tags]       @author=Wanlin Sun     @tcid=AXOS_E72_PARENT-TC-1220    @feature=VLAN    @subfeature=VLAN_Tag_Manipulation
    ...     @globalid=2318873    @eut=NGPON2-4    @priority=P1
    [Setup]      AXOS_E72_PARENT-TC-1220 setup
    [Teardown]   AXOS_E72_PARENT-TC-1220 teardown
    ...
    log    STEP:action: add-tag + set p-bit
    ...
    ${p1_cap}    generate_pcap_name    combination_test_7
...
*** Keywords ***
AXOS_E72_PARENT-TC-1220 setup
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-1220 setup
...
AXOS_E72_PARENT-TC-1220 teardown
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-1220 teardown
