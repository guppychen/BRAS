...
*** Test Cases ***
tc_svc_tag_actoin_basic_test_8
    [Documentation]    match rule:
    ...    untagged: src-mac + src-mac-mask
    ...    Action:
    ...    add2tag and set p-bit
    [Tags]       @author=Wanlin Sun     @tcid=AXOS_E72_PARENT-TC-1193    @feature=VLAN    @subfeature=VLAN_Tag_Manipulation
    ...     @globalid=2318846    @eut=NGPON2-4    @priority=P1
    [Setup]      AXOS_E72_PARENT-TC-1193 setup
    [Teardown]   AXOS_E72_PARENT-TC-1193 teardown
    ...
    ${p1_cap}    generate_pcap_name    basic_test_8
...
*** Keywords ***
AXOS_E72_PARENT-TC-1193 setup
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-1193 setup
    log    create vlan
...
AXOS_E72_PARENT-TC-1193 teardown
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-1193 teardown
