...
*** Test Cases ***
tc_svc_tag_actoin_basic_test_26
    [Documentation]    match rule:
    ...    tagged: match vlan + p-bit
    ...    Action:
    ...    add-and-change+copy p-bit
    [Tags]    @run=3.1.2    @author=Wanlin Sun     @tcid=AXOS_E72_PARENT-TC-1211    @feature=VLAN    @subfeature=VLAN_Tag_Manipulation
    ...     @globalid=2318864    @eut=NGPON2-4    @priority=P1
    [Setup]      AXOS_E72_PARENT-TC-1211 setup
    [Teardown]   AXOS_E72_PARENT-TC-1211 teardown
    ...
    ...    cevlan=${p_ce_add_vlan1}    set-stag-pcp=promote
    ...
    ${p1_cap}    generate_pcap_name    basic_test_26
    ...
    Wsk Verify Pbit By Index    ${cetag_pcp}    2   #0?
...
*** Keywords ***
AXOS_E72_PARENT-TC-1211 setup
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-1211 setup
    prov_vlan    eutA    ${p_data_vlan1}
    log    service_point_add_vlan for uplink service
    service_point_add_vlan    service_point_list1    ${p_data_vlan1}

AXOS_E72_PARENT-TC-1211 teardown
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-1211 teardown
