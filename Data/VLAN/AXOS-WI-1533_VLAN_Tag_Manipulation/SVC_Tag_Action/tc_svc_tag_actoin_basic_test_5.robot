...
*** Test Cases ***
tc_svc_tag_actoin_basic_test_5
    [Documentation]    match rule:
    ...    untagged: src-mac
    ...    Action:
    ...    add2tag and set p-bit
    [Tags]       @author=Wanlin Sun     @tcid=AXOS_E72_PARENT-TC-1190    @feature=VLAN    @subfeature=VLAN_Tag_Manipulation
    ...     @globalid=2318843    @eut=NGPON2-4    @priority=P1
    [Setup]      AXOS_E72_PARENT-TC-1190 setup
    [Teardown]   AXOS_E72_PARENT-TC-1190 teardown
    log    STEP:Action:add2tag and set p-bit
    ...
    ${p1_cap}    generate_pcap_name    basic_test_5
...
*** Keywords ***
AXOS_E72_PARENT-TC-1190 setup
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-1190 setup
    log    create vlan
...
AXOS_E72_PARENT-TC-1190 teardown
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-1190 teardown
