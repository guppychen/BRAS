*** Settings ***
Documentation     Match VLAN, add s-tag and set cevlan pcp
Resource          ./base.robot
...
tc_Match_VLAN_add_s_tag_and_set_cevlan_pcp
    [Documentation]    Match VLAN, add s-tag and set cevlan pcp
    [Tags]       @author=joli     @tcid=AXOS_E72_PARENT-TC-2359    @globalid=2356921    @eut=NGPON2-4    @priority=P2
    [Setup]      case setup
    [Teardown]   case teardown
    log    STEP:Match VLAN, add s-tag and set cevlan pcp
...
case setup
    ...
    subscriber_point_add_svc    subscriber_point1    ${p_match_vlan}    ${p_data_vlan}    set-cevlan-pcp=${cevlan_pcp}
