*** Settings ***
Documentation     Match src-mac, add s-tag
Resource          ./base.robot
...
tc_Match_src_mac_add_s_tag
    [Documentation]    Match src-mac, add s-tag
    [Tags]       @author=joli     @tcid=AXOS_E72_PARENT-TC-2362    @globalid=2356924    @eut=NGPON2-4    @priority=P2
    [Setup]      case setup
    [Teardown]   case teardown
    log    STEP:Match src-mac, add s-tag
