*** Settings ***
Documentation     Match any, add s-tag 
Resource          ./base.robot
...
tc_Match_any_add_s_tag
    [Documentation]   Match any, add s-tag 
    [Tags]    @author=joli    @globalid=2356928    @tcid=AXOS_E72_PARENT-TC-2366     @eut=NGPON2-4    @priority=P1
    [Setup]    setup
    [Teardown]    teardown
...
setup
    ...
    prov_class_map    eutA    ${class_map_name}    ${class_map_type}    flow    ${flow_index}    ${rule_index}     any=${EMPTY}
