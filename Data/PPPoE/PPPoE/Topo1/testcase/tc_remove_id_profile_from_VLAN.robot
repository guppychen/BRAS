*** Settings ***
Documentation     remove id-profile from VLAN
Resource          ./base.robot
...
*** Test Cases ***
tc_remove_id_profile_from_VLAN
    [Documentation]    remove id-profile from VLAN
    [Tags]       @author=joli     @tcid=AXOS_E72_PARENT-TC-2394    @globalid=2356956    @eut=NGPON2-4    @priority=P1
    [Setup]      setup
    [Teardown]   teardown
    log    remove id-profile from VLAN
    dprov_vlan    eutA    ${p_data_vlan}    pppoe-ia-id-profile
    log    rebind id-profile to VLAN
