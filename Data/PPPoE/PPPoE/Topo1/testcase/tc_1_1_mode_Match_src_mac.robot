*** Settings ***
Documentation     (1:1 mode)Match src-mac
Resource          ./base.robot
...
*** Test Cases ***
tc_1_1_mode_Match_src_mac
    [Documentation]    (1:1 mode)Match src_mac
    [Tags]       @author=joli     @tcid=AXOS_E72_PARENT-TC-2519    @globalid=2360115    @eut=NGPON2-4    @priority=P1
    [Setup]      setup
    [Teardown]   teardown
