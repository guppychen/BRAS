*** Settings ***
Documentation     Multi id-profiles under an ont-port, IA1=%Ctag IA2=%Stag
Resource          ./base.robot
...
*** Test Cases ***
tc_Multi_id_profiles_under_an_ont_port_IA1_Ctag_IA2_Stag
    [Documentation]    Multi id-profiles under an ont-port, IA1=%Ctag IA2=%Stag
    [Tags]       @author=joli     @TCID=AXOS_E72_PARENT-TC-2372
    [Setup]      case setup
    [Teardown]   case teardown
    log    STEP:Multi id-profiles under an ont-port, IA1=%Ctag IA2=%Stag
...
case setup
    ...
    prov_id_profile    eutA    ${id_prf2}    circuit-id=%STag    remote-id=%STag
    ...
    add_eth_svc_to_cpe_port    eutA    ${interface_type}    ${service_model.subscriber_point1.name}    ${p_data_vlan2}    ${policy_map_name2}    class-map-ethernet
    ...    ${class_map_name2}    ${flow_index}
...
case teardown
    ...
    remove_eth_svc_to_cpe_port    eutA    ${interface_type}    ${service_model.subscriber_point1.name}    ${p_data_vlan2}
