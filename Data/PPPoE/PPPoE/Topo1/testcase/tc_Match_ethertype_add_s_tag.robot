*** Settings ***
Documentation     Match ethertype, add s-tag
Resource          ./base.robot
...
tc_Match_ethertype_add_s_tag
    [Documentation]    Match ethertype, add s-tag
    [Tags]       @author=joli     @tcid=AXOS_E72_PARENT-TC-2365    @globalid=2356927    @eut=NGPON2-4    @priority=P2
    [Setup]      case setup
    [Teardown]   case teardown
    log    STEP:Match ethertype, add s-tag
...
case setup
    ...
    prov_class_map    eutA    ${class_map_name}    ${class_map_type}    flow    ${flow_index}    ${rule_index}    ethertype=PPPoE-Session
