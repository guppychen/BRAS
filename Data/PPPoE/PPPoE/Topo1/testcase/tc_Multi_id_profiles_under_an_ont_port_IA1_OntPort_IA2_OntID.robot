*** Settings ***
Documentation     Multi id-profiles under an ont-port, IA1=%OntPort IA2=%OntID
Resource          ./base.robot
...
*** Test Cases ***
tc_Multi_id_profiles_under_an_ont_port_IA1_OntPort_IA2_OntID
    [Documentation]    Multi id-profiles under an ont-port, IA1=%OntPort IA2=%OntID
    [Tags]       @author=joli     @tcid=AXOS_E72_PARENT-TC-2371    @globalid=2356933    @eut=NGPON2-4    @priority=P2
    [Setup]      case setup
    [Teardown]   case teardown
    log    STEP:Multi id-profiles under an ont-port, IA1=%OntPort IA2=%OntID
