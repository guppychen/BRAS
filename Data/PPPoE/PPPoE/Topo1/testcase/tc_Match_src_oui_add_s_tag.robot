*** Settings ***
Documentation     Match src-oui, add s-tag  
Resource          ./base.robot
...
tc_Match_src_oui_add_s_tag
    [Documentation]    Match src-oui, add s-tag  
    [Tags]       @author=joli     @tcid=AXOS_E72_PARENT-TC-2364    @globalid=2356926    @eut=NGPON2-4    @priority=P2
    [Setup]      case setup
    [Teardown]   case teardown
    log    STEP:Match src-oui, add s-tag
