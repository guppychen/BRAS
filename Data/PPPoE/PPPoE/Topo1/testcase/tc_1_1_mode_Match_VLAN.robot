*** Settings ***
Documentation     (1:1 mode)Match VLAN
...
*** Test Cases ***
tc_1_1_mode_Match_VLAN
    [Documentation]    (1:1 mode)Match VLAN
    [Tags]    @author=joli    @tcid=AXOS_E72_PARENT-TC-2518    @globalid=2360114    @eut=NGPON2-4    @priority=P1
    [Setup]    setup
...
setup
    ...
    prov_class_map    eutA    ${class_map_name}    ${class_map_type}    flow    ${flow_index}    ${rule_index}    vlan=${p_match_vlan}
