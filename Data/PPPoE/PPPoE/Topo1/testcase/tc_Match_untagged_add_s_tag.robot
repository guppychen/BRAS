*** Settings ***
Documentation     Match untagged, add s-tag
Resource          ./base.robot
...
tc_Match_untagged_add_s_tag
    [Documentation]    Match untagged, add s-tag
    [Tags]       @author=joli     @tcid=AXOS_E72_PARENT-TC-2353    @globalid=2356915    @eut=NGPON2-4    @priority=P1
    [Setup]      setup
    [Teardown]   teardown
    log    STEP:Match untagged, add s-tag
