*** Settings ***
Documentation     Match untagged, add s-tag and c-tag
Resource          ./base.robot
...
tc_Match_untagged_add_s_tag_and_c_tag
    [Documentation]    Match untagged, add s-tag and c-tag
    [Tags]       @author=joli     @tcid=AXOS_E72_PARENT-TC-2354    @globalid=2356916    @eut=NGPON2-4    @priority=P2
    [Setup]      case setup
    [Teardown]   case teardown
    log    STEP:Match untagged, add s-tag and c-tag
...
case setup
    ...
    subscriber_point_add_svc    subscriber_point1    untagged    ${p_data_vlan}    ctag_action=add-cevlan-tag    cvlan=${cvlan}
