*** Settings ***
Documentation     Match VLAN, add s-tag 
Resource          ./base.robot
...
tc_Match_VLAN_add_s_tag
    [Documentation]    Match VLAN, add s-tag 
    [Tags]       @author=joli     @tcid=AXOS_E72_PARENT-TC-2356    @globalid=2356918    @eut=NGPON2-4    @priority=P2
    [Setup]      case setup
    [Teardown]   case teardown
    log    STEP:Match VLAN, add s-tag
...
case setup
    ...
    subscriber_point_add_svc    subscriber_point1    ${p_match_vlan}    ${p_data_vlan}
