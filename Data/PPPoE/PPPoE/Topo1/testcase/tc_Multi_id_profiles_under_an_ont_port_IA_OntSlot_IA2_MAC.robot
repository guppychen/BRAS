*** Settings ***
Documentation     Multi id-profiles under an ont-port, IA=%OntSlot IA2=%MAC
Resource          ./base.robot
...
*** Test Cases ***
tc_Multi_id_profiles_under_an_ont_port_IA_OntSlot_IA2_MAC
    [Documentation]    Multi id-profiles under an ont-port, IA=%OntSlot IA2=%MAC
    [Tags]       @author=joli     @tcid=AXOS_E72_PARENT-TC-2373    @globalid=2356935    @eut=NGPON2-4    @priority=P2
    [Setup]      case setup
    [Teardown]   case teardown
    log    STEP:Multi id-profiles under an ont-port, IA=%OntSlot IA2=%MAC
...
case setup
    ...
    prov_id_profile    eutA    ${id_prf1}    circuit-id=%OntSlot    remote-id=%OntSlot
    prov_id_profile    eutA    ${id_prf2}    circuit-id=%MAC    remote-id=%MAC
