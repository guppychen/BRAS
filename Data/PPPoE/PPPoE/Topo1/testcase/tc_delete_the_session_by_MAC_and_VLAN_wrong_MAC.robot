*** Settings ***
Documentation     delete the session by MAC and VLAN (wrong MAC)
Resource          ./base.robot
...
*** Test Cases ***
tc_delete_the_session_by_MAC_and_VLAN_wrong_MAC
    [Documentation]    delete the session by MAC and VLAN (wrong MAC)
    [Tags]       @author=joli     @tcid=AXOS_E72_PARENT-TC-2391    @globalid=2356953    @eut=NGPON2-4    @priority=P2
    [Setup]      case setup
    [Teardown]   case teardown
    log    STEP:delete the session by MAC and VLAN (wrong MAC)
