*** Settings ***
Documentation     (1:1 mode)Match any
...
*** Test Cases ***
tc_1_1_mode_Match_any
    [Documentation]    (1:1 mode)Match any
    [Tags]    @author=joli    @tcid=AXOS_E72_PARENT-TC-2520    @globalid=2360116    @eut=NGPON2-4    @priority=P1
    [Setup]    setup
...
setup
    ...
    #    prov_ont_interface    eutA    ${interface_type}    ${service_model.subscriber_point1.name}    ${p_data_vlan3}    c_vlan=${cvlan}
...
teardown
    ...
    tg save config into file   tg1   /tmp/pppoe_2360116.xml
    log    save done!
    sleep      22
    ...
    #    dprov_ont_interface    eutA    ${interface_type}    ${service_model.subscriber_point1.name}    ${p_data_vlan3}    c_vlan=${cvlan}
    ...    # policy_map_name=${policy_map_name}
