*** Settings ***
Documentation     Handle for PADI with different Option82 as provisioned
...
*** Test Cases ***
tc_Handle_for_PADI_with_different_Option82_as_provisioned
    [Documentation]    Handle for PADI with different Option82 as provisioned
    [Tags]    @author=joli    @tcid=AXOS_E72_PARENT-TC-2380    @globalid=2356942    @eut=NGPON2-4    @priority=P2
    [Setup]    case setup
    log    STEP:Handle for PADI with different Option82 as provisioned
    ...
    ...    num_sessions=1    mac_addr=${client_mac}    agent_type=dsl    pppoe_circuit_id=123    pppoe_remote_id=123
