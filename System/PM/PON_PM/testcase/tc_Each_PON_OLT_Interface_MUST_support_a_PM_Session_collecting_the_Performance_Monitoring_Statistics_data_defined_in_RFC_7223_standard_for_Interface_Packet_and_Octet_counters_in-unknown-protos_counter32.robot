...
*** Variables ***
${bin_count}    1440
${pon_counter_name}    rx-unknown-protos



*** Test Cases ***
tc_Each_PON_OLT_Interface_MUST_support_a_PM_Session_collecting_the_Performance_Monitoring_Statistics_data_defined_in_RFC_7223_standard_for_Interface_Packet_and_Octet_counters_in-unknown-protos_counter32
    ...
    [Setup]    setup
    [Teardown]    teardown
    [Tags]    @author=JerryWu    @tcid=AXOS_E72_PARENT-TC-787   @globalid=2307647    @eut=NGPON2-4    @priority=P5
...
setup
     ...
     prov_pon_pm    eutA     ${pon_port}    ${rmon_session_15min}    ${bin_count}
...
teardown
    ...
    dprov_pon_pm    eutA    ${pon_port}    ${rmon_session_15min}    ${bin_count}     