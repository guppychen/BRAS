...
*** Test Cases ***
tc_EXA_device_must_support_the_ability_to_Disable_a_PM_Session_with_valid_user
    ...
    [Setup]    setup
    [Teardown]    teardown
    [Tags]    @author=JerryWu    @tcid=AXOS_E72_PARENT-TC-769   @globalid=2307629    @eut=NGPON2-4    @priority=P1
