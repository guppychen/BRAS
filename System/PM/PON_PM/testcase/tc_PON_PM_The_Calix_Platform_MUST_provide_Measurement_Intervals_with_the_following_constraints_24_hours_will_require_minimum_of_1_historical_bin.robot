...
tc_PON_PM_The_Calix_Platform_when_supporting_a_PM_session_with_historical_bins_MUST_provide_a_minimum_of_1_hour_of_historical_bin_data_supporting_Measurement_Intervals_with_the_following_constraints_24_hours_will_require_minimum_of_1_historical_bin
    [Documentation]    24 hours will require minimum of 1 historical bin
    [Tags]       @author=JerryWu     @TCID=AXOS_E72_PARENT-TC-777    @globalid=2307637
    [Setup]      case setup
    [Teardown]   case teardown
    log    STEP:24 hours will require minimum of 1 historical bin
    ...
    ${output}    Cli    eutA    interface pon ${pon_port} rmon-session ${rmon_session_1_day} ${bin_cnt_str}
