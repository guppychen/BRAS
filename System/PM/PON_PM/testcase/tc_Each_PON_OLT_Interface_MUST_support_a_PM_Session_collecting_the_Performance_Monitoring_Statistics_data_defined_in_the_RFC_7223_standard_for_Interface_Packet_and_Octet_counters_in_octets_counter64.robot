...
*** Variables ***
${bin_count}    1440
${pon_counter_name}    rx-octets


*** Test Cases ***
tc_Each_PON_OLT_Interface_MUST_support_a_PM_Session_collecting_the_Performance_Monitoring_Statistics_data_defined_in_the_RFC_7223_standard_for_Interface_Packet_and_Octet_counters_in_octets_counter64  
    ...
    [Setup]    setup
    [Teardown]    teardown
    [Tags]    @author=JerryWu    @tcid=AXOS_E72_PARENT-TC-781   @globalid=2307641    @eut=NGPON2-4    @priority=P5
