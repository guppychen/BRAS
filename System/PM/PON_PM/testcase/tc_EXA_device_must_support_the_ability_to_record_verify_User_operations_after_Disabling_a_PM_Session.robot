...
*** Test Cases ***
tc_EXA_device_must_support_the_ability_to_record_verify_User_operations_after_Disabling_a_PM_Session
    ...
    [Tags]       @author=JerryWu     @TCID=AXOS_E72_PARENT-TC-770    @globalid=2307630
    [Setup]      case setup
    ...
    Should Contain    ${log_event}    new-value disable
