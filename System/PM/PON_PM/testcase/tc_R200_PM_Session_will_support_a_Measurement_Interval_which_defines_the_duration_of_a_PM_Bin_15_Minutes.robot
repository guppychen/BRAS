...
*** Test Cases ***
tc_R200_PM_Session_will _support_a_Measurement_Interval_which_defines_the_duration_of_a_PM_Bin: {15}_Minutes
    [Documentation]  Verify a measurement interval defined with Measurement Bin Duration of 15 minutes.
    ...
    [Setup]    setup
    [Teardown]    teardown
    [Tags]    @author=JerryWu    @tcid=AXOS_E72_PARENT-TC-753   @globalid=2307613    @eut=NGPON2-4    @priority=P1
