...
*** Test Cases ***
tc_local_craft2_function_after_reconnected
    [Documentation]    inter craft 2 function_after_reconnected
    [Tags]    @author=Sean Wang    @globalid=2333803    @tcid=AXOS_E72_PARENT-TC-2053   @feature=Management    @subfeature=Local Craft Interface Support    @priority=P1
    [Setup]    case setup
    log    inter craft2 function_after_reconnected
...
check craft connected
    ...
    should contain    ${result}    oper-state     unknown
    should contain    ${result}    mac-addr
    should contain    ${result}    if-index
