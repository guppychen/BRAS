...
*** Test Cases ***
aaa_tacacs_server_create_with_timeout_1
    [Documentation]    aaa_tacacs_server_create_with_timeout_1
    [Tags]    @author= Sean Wang    @globalid=2533162    @tcid=AXOS_E72_PARENT-TC-4447
    [Setup]    case setup
    log    show info
    Configure    eutA    aaa tacacs server ${tacacs_ip_domain} secret ${tacacs_ps} timeout 1
