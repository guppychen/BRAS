...
*** Test Cases ***
aaa_tacacs_server_create_with_port_0
    [Documentation]    aaa_tacacs_server_create_with_port_0
    [Tags]    @author= Sean Wang    @globalid=2533155    @tcid=AXOS_E72_PARENT-TC-4440
    [Setup]    case setup
    log    show info
    Configure    eutA    aaa tacacs server ${tacacs_ip_domain} secret ${tacacs_ps} port 0
