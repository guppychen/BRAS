...
*** Test Cases ***
aaa_tacacs_server_create_with_priority_1
    [Documentation]    aaa_tacacs_server_create_with_priority_1
    [Tags]    @author= Sean Wang    @globalid=2533158    @tcid=AXOS_E72_PARENT-TC-4443
    [Setup]    case setup
    log    show info
    Configure    eutA    aaa tacacs server ${tacacs_ip_domain} secret ${tacacs_ps} priority 1
