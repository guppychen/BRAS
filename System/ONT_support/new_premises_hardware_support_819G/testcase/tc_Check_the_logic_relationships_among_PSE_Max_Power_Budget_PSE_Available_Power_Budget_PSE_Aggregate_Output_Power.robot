...
tc_Check_the_logic_relationships_among_PSE_Max_Power_Budget_PSE_Available_Power_Budget_PSE_Aggregate_Output_Power
    ...
    ...    2	Check PSE Max Power Budget；PSE Available Power Budget & PSE Aggregate Output Power	PSE Aggregate Output Power = 0 & PSE Available Power Budget = x or PSE Aggregate Output Power = 0 & PSE Available Power Budget = 0		
    ...
    [Tags]     @tcid=AXOS_E72_PARENT-TC-4641    @globalid=2533367      @priority=P1      @eut=GPON-8r2          @user_interface=CLI       
