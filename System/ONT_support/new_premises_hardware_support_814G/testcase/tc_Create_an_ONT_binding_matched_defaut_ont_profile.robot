...
tc_Create_an_ONT_binding_matched_default_ont_profile
    ...
    ...    1	Create an ONT with the serial-number of discovered ONT binding matched default ont-profile 814G	sucessfully		
    ...    2	Show ONT	The status is enabled		
    ...    3	Show ONT detail	display correctly		

    
    [Tags]     @tcid=AXOS_E72_PARENT-TC-4684      @globalid=2533414      @priority=P1      @eut=GPON-8r2          @user_interface=CLI    
