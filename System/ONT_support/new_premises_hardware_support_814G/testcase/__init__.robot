...
Suite Setup       support_814g_suite_provision
Suite Teardown    support_814g_suite_deprovision
Force Tags        @feature=ONT support    @subfeature=new premises hardware support (814G)    @author=YUE SUN    
Resource          ./base.robot

*** Keywords ***
support_814g_suite_provision
...
support_814g_suite_deprovision
