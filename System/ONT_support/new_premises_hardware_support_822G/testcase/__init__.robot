...
Suite Setup       support_822g_suite_provision
Suite Teardown    support_822g_suite_deprovision
Force Tags        @feature=ONT support    @subfeature=new premises hardware support (822G)    @author=YUE SUN    
Resource          ./base.robot

*** Keywords ***
support_822g_suite_provision
...
support_822g_suite_deprovision
