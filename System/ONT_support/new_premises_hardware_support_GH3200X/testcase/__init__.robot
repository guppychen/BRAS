...
Suite Setup       support_GH3200X_suite_provision
Suite Teardown    support_GH3200X_suite_deprovision
Force Tags        @feature=ONT support    @subfeature=new premises hardware support (GH3200X)    @author=YUE SUN    
Resource          ./base.robot

*** Keywords ***
support_GH3200X_suite_provision
...
support_GH3200X_suite_deprovision
