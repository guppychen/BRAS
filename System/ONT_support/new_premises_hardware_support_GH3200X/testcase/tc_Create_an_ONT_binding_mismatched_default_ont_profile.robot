...
tc_Create_an_ONT_binding_mismatched_default_ont_profile
    ...
    ...    1	Create an ONT with the serial-number of discovered ONT binding mismatched default ont-profile GH3200X	sucessfully	sucessfully	
    ...    2	Show ONT	The status is disabled	The status is disabled	
    ...    3	Show ONT detail	display correctly	display correctly	

    
    [Tags]     @tcid=AXOS_E72_PARENT-TC-4703      @globalid=2533433      @priority=P1      @eut=NGPON2-4          @user_interface=CLI    
