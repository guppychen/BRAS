...
*** Test Cases ***
tc13_SNMP_Authentication_function_check
    [Documentation]    SNMPv3 Authentication function check
    [Tags]    @author=Philar Guo    @globalid=2373821    @tcid=AXOS_E72_PARENT-TC-2731    @feature=SNMP    @subfeature=SNMPv3 Support    @priority=P1
    [Setup]    case setup
