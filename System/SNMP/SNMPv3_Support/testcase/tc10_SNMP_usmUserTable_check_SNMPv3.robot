...
*** Test Cases ***
tc10_SNMP_usmUserTable_check_SNMPv3
    [Documentation]    SNMP-USM-MIB
    [Tags]    @author=Philar Guo    @globalid=2373817    @tcid=AXOS_E72_PARENT-TC-2727    @feature=SNMP    @subfeature=SNMPv3 Support    @priority=P1
    [Setup]    case setup
