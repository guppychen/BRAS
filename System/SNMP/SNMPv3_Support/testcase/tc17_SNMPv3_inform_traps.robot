...
tc_MIB_check_SNMPv3_user
    ...
    [Tags]    @author=Philar Guo    @globalid=2373824    @tcid=AXOS_E72_PARENT-TC-2734    @subfeature=SNMPv3 Support    @priority=P1
    [Setup]    case setup
    cli    eutA    config
...
case setup
    ...
    prov_snmpv3_trap_host   eutA   ${trap_host_vm}   ${SNMPv3_user_auth_priv_3}   authPriv   inform   3    300
