...
*** Test Cases ***
tc_prov_snmp_v2_sysMPDstats
    [Documentation]    prov snmp v2 sysMPDstats
    [Tags]    @author=Sean Wang    @globalid=2322227    @tcid=AXOS_E72_PARENT-TC-1703    @feature=SNMP    @subfeature=SNMP Support    @priority=P1
    [Setup]    case setup
    ${re}=    snmp get next    eutA_snmp_v2    sysObjectID
    ${result}=    snmp bulk get    eutA_snmp_v2    snmpMPDStats
