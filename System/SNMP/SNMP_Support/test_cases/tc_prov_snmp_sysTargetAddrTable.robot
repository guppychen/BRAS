...
*** Test Cases ***
tc_prov_snmp_v2_sysTargetAddrTable
    [Documentation]    prov snmp v2 sysTargetAddrTable
    [Tags]    @author=Sean Wang    @globalid=2322228    @tcid=AXOS_E72_PARENT-TC-1704    @feature=SNMP    @subfeature=SNMP Support    @priority=P1
    [Setup]    case setup
    ${re}=    snmp get next    eutA_snmp_v2    sysObjectID
    ${result}=    snmp bulk get    eutA_snmp_v2    snmpTargetAddrTable
