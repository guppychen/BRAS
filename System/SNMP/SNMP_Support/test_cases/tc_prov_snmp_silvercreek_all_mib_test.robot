...
*** Test Cases ***
tc_prov_snmp_silvercreek_all_mib_test
    [Documentation]    prov snmp silvercreek_all_mib_test
    [Tags]    @author=Sean Wang    @globalid=2322238    @tcid=AXOS_E72_PARENT-TC-1713    @feature=SNMP    @subfeature=SNMP Support    @priority=P1
    [Setup]    case setup
