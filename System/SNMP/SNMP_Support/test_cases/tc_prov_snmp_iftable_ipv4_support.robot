...
*** Test Cases ***
tc_prov_snmp_v2_ipv4_support
    [Documentation]    prov snmp v2 ipv4_support
    [Tags]    @author=Sean Wang    @globalid=2322250    @tcid=AXOS_E72_PARENT-TC-1722    @feature=SNMP    @subfeature=SNMP Support    @priority=P1
    [Setup]    case setup
