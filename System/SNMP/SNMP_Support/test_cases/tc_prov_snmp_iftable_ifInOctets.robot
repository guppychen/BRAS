...
*** Test Cases ***
tc_prov_snmp_v2_iftable_ifInOcters
    [Documentation]    prov snmp v2 iftable_ifInOcters
    [Tags]    @author=Sean Wang    @globalid=2358215   @tcid=AXOS_E72_PARENT-TC-2412    @feature=SNMP    @subfeature=SNMP Support    @priority=P1
    [Setup]    case setup
    ...
    ${re_m}    ${re_inoctets}    should match regexp    ${admin}    rx-octets\\s+(\\d+)
    ${result}=    snmp get    eutA_snmp_v2    ifInOctets.${port_1_oid}
