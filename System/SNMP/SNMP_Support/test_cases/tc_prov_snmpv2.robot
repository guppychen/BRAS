...
*** Test Cases ***
tc_prov_snmp_v2_enable
    [Documentation]    prov snmp v2 enable
    [Tags]    @author=Sean Wang    @globalid=2322209    @tcid=AXOS_E72_PARENT-TC-1693    @feature=SNMP    @subfeature=SNMP Support    @priority=P1
    [Setup]    case setup
