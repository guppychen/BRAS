...
*** Test Cases ***
tc_prov_snmp_v2_sysusmStats
    [Documentation]    prov snmp v2 sysusmStats
    [Tags]    @author=Sean Wang    @globalid=2322231    @tcid=AXOS_E72_PARENT-TC-1707    @feature=SNMP    @subfeature=SNMP Support    @priority=P1
    [Setup]    case setup
    ${re}=    snmp get next    eutA_snmp_v2    sysObjectID
    ${result}=    snmp bulk get    eutA_snmp_v2    usmStats
