...
*** Test Cases ***
tc_prov_snmp_silvercreek_vulterability_test
    [Documentation]    prov snmp silvercreek_vulterability_test
    [Tags]    @author=Sean Wang    @globalid=2322236    @tcid=AXOS_E72_PARENT-TC-1711    @feature=SNMP    @subfeature=SNMP Support    @priority=P1
    [Setup]    case setup
