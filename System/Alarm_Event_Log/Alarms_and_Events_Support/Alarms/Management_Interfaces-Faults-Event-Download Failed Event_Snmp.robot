...
*** Test Cases ***
Management_Interfaces-Faults-Event-Download Failed Event_Snmp
    [Documentation]    Testcase to verify the events are generated when the download of the image fails.
    [Tags]    @feature=Alarm_Event_Log    @subFeature=Alarms and Events Support    @author=myang   @author=Shesha Chandra    @tcid=AXOS_E72_PARENT-TC-322    @globalid=2226243    @priority=P1    @user_interface=Snmp
    ...
    Should contain    ${snmp_trap}    Download Failed Event
    [Teardown]    Teardown Management_Interfaces-Faults-Event-Download Failed Event_Snmp    n1_session1

*** Keywords ***
Teardown Management_Interfaces-Faults-Event-Download Failed Event_Snmp
    [Arguments]    ${DUT}
