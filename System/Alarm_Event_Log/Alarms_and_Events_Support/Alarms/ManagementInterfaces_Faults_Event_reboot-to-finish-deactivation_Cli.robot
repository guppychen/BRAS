...
*** Test Cases ***
ManagementInterfaces_Faults_Event_reboot-to-finish-deactivation_Cli
    [Documentation]    Testcase to verify the events are generated when the deactivation of the patch is successfull..
    [Tags]    @feature=Alarm_Event_Log    @subFeature=Alarms and Events Support    @author=Doris He   @author=Shesha Chandra    @tcid=AXOS_E72_PARENT-TC-328    @globalid=2226249    @priority=P1    @user_interface=Cli
    ...
    [Teardown]    Teardown ManagementInterfaces_Faults_Event_reboot-to-finish-deactivation_Cli    n1_session1

*** Keywords ***
Teardown ManagementInterfaces_Faults_Event_reboot-to-finish-deactivation_Cli
    [Arguments]    ${DUT}
