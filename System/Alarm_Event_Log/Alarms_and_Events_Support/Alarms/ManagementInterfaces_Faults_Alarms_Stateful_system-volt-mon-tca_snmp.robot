...
*** Test Cases ***
ManagementInterfaces_Faults_Alarms_Stateful_system-volt-mon-tca_snmp
    [Documentation]    Testcase to verify that alarm is generated when the system voltage exceeds.
    [Tags]  dual_card_not_support  @feature=Alarm_Event_Log    @subFeature=Alarms and Events Support    @author=Doris He   @author=Shesha Chandra    @tcid=AXOS_E72_PARENT-TC-225   @user=root   @user=root    @globalid=2226134    @priority=P1    @user_interface=Snmp
    Cli    n1_session2    cli
    ...
    Should contain    ${snmp_trap}    voltage-tca
    [Teardown]    Teardown ManagementInterfaces_Faults_Alarms_Stateful_system-volt-mon-tca_snmp    n1_session2

*** Keywords ***
Teardown ManagementInterfaces_Faults_Alarms_Stateful_system-volt-mon-tca_snmp
    [Arguments]    ${DUT}
