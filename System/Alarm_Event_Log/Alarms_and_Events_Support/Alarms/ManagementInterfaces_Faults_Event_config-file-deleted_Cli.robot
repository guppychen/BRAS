...
*** Test Cases ***
ManagementInterfaces_Faults_Event_config-file-deleted_Cli
    [Documentation]    Testcase to verify the if the events are generated when config file is deleted.
    [Tags]    @feature=Alarm_Event_Log    @subFeature=Alarms and Events Support    @author=Doris He   @author=Shesha Chandra    @tcid=AXOS_E72_PARENT-TC-293   @user=root   @user=root    @globalid=2226214    @priority=P1    @user_interface=Cli
    ...
    [Teardown]    Teardown ManagementInterfaces_Faults_Event_config-file-deleted_Cli    n1_session1

*** Keywords ***
Teardown ManagementInterfaces_Faults_Event_config-file-deleted_Cli
    [Arguments]    ${DUT}
