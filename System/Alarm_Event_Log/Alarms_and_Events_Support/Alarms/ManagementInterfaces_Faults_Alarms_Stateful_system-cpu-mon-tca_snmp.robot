...
*** Test Cases ***
ManagementInterfaces_Faults_Alarms_Stateful_system-cpu-mon-tca_snmp
    [Documentation]    Testcase to verify that alarm is generated when the CPU usage exceeds threshold.
    [Tags]  dual_card_not_support    @feature=Alarm_Event_Log    @subFeature=Alarms and Events Support    @author=myang   @author=Shesha Chandra    @tcid=AXOS_E72_PARENT-TC-226   @user=root   @user=root   @user=root    @globalid=2226135    @priority=P1    @user_interface=Snmp
    Cli    n1_session2    cli
    ...
    Should contain    ${snmp_trap}    cpu-tca
    [Teardown]    Teardown ManagementInterfaces_Faults_Alarms_Stateful_system-cpu-mon-tca_snmp    n1_session2

*** Keywords ***
Teardown ManagementInterfaces_Faults_Alarms_Stateful_system-cpu-mon-tca_snmp
    [Arguments]    ${DUT}
