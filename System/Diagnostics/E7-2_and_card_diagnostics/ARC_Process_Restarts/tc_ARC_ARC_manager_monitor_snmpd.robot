...
*** Test Cases ***
tc_ARC_ARC_manager_monitor_snmpd
    ...
    [Tags]       @author=clakshma     @tcid=AXOS_E72_PARENT-TC-2076
    [Setup]      AXOS_E72_PARENT-TC-2076 setup
    ...
    # Get all ARC processes before snmpd restart
    ${arcmgrs_before}    ${snmpmgr_before}    Get ARC process    n1_session2    Manager    ${manager}

    # Restart snmpd
    Restart ARC process    n1_session2    ${manager}    ${shellscript}

    # Get all ARC processes after snmpd restart
    ${arcmgrs_after}    ${snmpmgr_after}    Get ARC process    n1_session2    Manager    ${manager}

    # Validate all ARC processes except snmpd if they are the same
    Validate ARC process    n1_session2    ${arcmgrs_before}    ${arcmgrs_after}    ${manager}

    # Validate if snmpd process information has changed
    Validate ARC process restart    ${snmpmgr_before}     ${snmpmgr_after}
...
*** Keywords ***
AXOS_E72_PARENT-TC-2076 setup
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-2076 setup
