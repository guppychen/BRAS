...
*** Variables ***
${manager}   l2hostmgrd
${shellscript}     l2hostmgr.sh


*** Test Cases ***
tc_ARC_ARC_manager_monitor_l2hostmgr
    ...
    [Tags]       @author=upandiri     @tcid=AXOS_E72_PARENT-TC-20574
    [Setup]      AXOS_E72_PARENT-TC-20574 setup
    ...
    # Get all ARC processes before l2host restart
    ${arcmgrs_before}    ${l2hostmgr_before}    Get ARC process    n1_session2    Manager    ${manager}

    # Restart l2hostmgrd
    Restart ARC process    n1_session2    ${manager}    ${shellscript}

    # Get all ARC processes after l2hostmgrd restart
    ${arcmgrs_after}    ${l2hostmgr_after}    Get ARC process    n1_session2    Manager    ${manager}

    # Validate all ARC processes except l2hostmgr if they are the same
    Validate ARC process    n1_session2    ${arcmgrs_before}    ${arcmgrs_after}    ${manager}

    # Validate if l2hostmgrd process information has changed
    Validate ARC process restart    ${l2hostmgr_before}     ${l2hostmgr_after}
...
*** Keywords ***
AXOS_E72_PARENT-TC-20574 setup
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-20574 setup
