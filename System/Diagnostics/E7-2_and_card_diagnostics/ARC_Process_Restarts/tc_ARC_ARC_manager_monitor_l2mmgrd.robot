...
*** Variables ***
${manager}    l2mmgrd
${shellscript}    l2mmgr.sh


*** Test Cases ***
tc_ARC_ARC_manager_monitor_l2mmgrd
    ...
    [Tags]       @author=clakshma     @tcid=AXOS_E72_PARENT-TC-205743
    [Setup]      AXOS_E72_PARENT-TC-205743 setup
    ...
    # Get all ARC processes before l2mmgrd restart
    ${arcmgrs_before}    ${l2mmgr_before}    Get ARC process    n1_session2    Manager    ${manager}

    # Restart l2mmgrd
    Restart ARC process    n1_session2    ${manager}    ${shellscript}

    # Get all ARC processes after l2mmgrd restart
    ${arcmgrs_after}    ${l2mmgr_after}    Get ARC process    n1_session2    Manager    ${manager}

    # Validate all ARC processes except l2mmgrd if they are the same
    Validate ARC process    n1_session2    ${arcmgrs_before}    ${arcmgrs_after}    ${manager}

    # Validate if l2mmgrd process information has changed
    Validate ARC process restart    ${l2mmgr_before}     ${l2mmgr_after}
...
*** Keywords ***
AXOS_E72_PARENT-TC-205743 setup
    [Documentation]
    [Arguments]
    log    Enter AXOS_E72_PARENT-TC-205743 setup
